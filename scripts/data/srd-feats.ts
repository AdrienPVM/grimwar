...
export const SRD_FEATS: SrdFeatEntry[] = [
  ...
  },
  {
    ...
    prerequisite: null,
    summary: {
      fr: "Choisissez une liste (Clerc, Druide ou Magicien) : vous apprenez 2 sorts mineurs + 1 sort de niveau 1 (lancé une fois par repos long sans slot). Choisissez Int, Sag ou Cha comme caractéristique d'incantation.",
