...
export const SRD_SPELLS: Spell[] = [
  ...
  },
  {
    ...
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts de Coup de la créature augmentent de 1d4 (taille M ou inférieure), 1d6 (taille G) ou 1d12 (taille TG) par niveau d’emplacement au-delà du 5e .", en: "Using a Higher-Level Spell Slot. The creature’s Slam damage increases by 1d4 (Medium or smaller), 1d6 (Large), or 1d12 (Huge) for each spell slot level above 5." },
    classes: ["bard","sorcerer","wizard"],
    summonedCreatureIds: ["objet-anime"],
    source: 'srd-5.2.1',
  },
  {
    id: "antidetection",
  ...
  },
  {
    ...
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Le niveau de l’emplacement de sort s’applique chaque fois que le profil de jeu y fait référence.", en: "Using a Higher-Level Spell Slot. Use the spell slot’s level for the spell’s level in the stat block." },
    classes: ["paladin"],
    summonedCreatureIds: ["monture-d-outre-monde"],
    source: 'srd-5.2.1',
  },
  {
  ...
  },
  {
    ...
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Le niveau de l’emplacement s’applique chaque fois que le profil de jeu y fait référence.", en: "Using a Higher-Level Spell Slot. Use the spell slot’s level for the spell’s level in the stat block." },
    classes: ["wizard"],
    summonedCreatureIds: ["esprit-draconique"],
    source: 'srd-5.2.1',
  },
  {
  ...
  },
  {
    ...
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Le niveau de l’emplacement de sort s’applique chaque fois que le profil de jeu y fait référence.", en: "Using a Higher-Level Spell Slot. Use the spell slot’s level for the spell’s level in the stat block." },
    classes: ["druid"],
    summonedCreatureIds: ["insecte-geant-invoque"],
    source: 'srd-5.2.1',
  },
  {
    id: "interdiction",
