/**
 * SRD 5.2.1 — Sorts, bilingue (FR + EN). 339 entrées.
 *
...
export const SRD_SPELLS: Spell[] = [
  ...
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une bandelette de tissu blanc", en: "a strip of white cloth" } },
    duration: { fr: "8 heures", en: "8 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Choisissez jusqu’à trois créatures à portée. Le maximum de points de vie de chaque cible et ses points de vie actuels augmentent de 5 pour toute la durée.", en: "Choose up to three creatures within range. Each target’s Hit Point maximum and current Hit Points increase by 5 for the duration." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les points de vie de chaque cible augmentent de 5 de plus par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. Each target’s Hit Points increase by 5 for each spell slot level above 2." },
  ...
  {
    id: "alienation",
    name: { fr: "Aliénation", en: "Befuddlement" },
    level: 8,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "45 m", en: "150 feet" },
    components: { v: true, s: true, m: true, material: { fr: "l’anneau seul d’un trousseau de clefs", en: "a key ring with no keys" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous assaillez l’esprit d’une créature que vous voyez à portée. La cible effectue un jet de sauvegarde d’Intelligence. En cas d’échec, elle subit 10d12 dégâts psychiques et ne peut pas lancer de sort ni entreprendre l’action Magie. À l’issue de chaque tranche de 30 jours, la cible réitère le JS et met un terme à l’effet en cas de réussite. Les sorts guérison, restauration suprême et souhait mettent également chacun fin à l’effet. En cas de réussite, la cible subit uniquement la moitié de ces dégâts.", en: "You blast the mind of a creature that you can see within range. The target makes an Intelligence saving t hrow.\nOn a failed save, the target takes 10d12 Psychic damage and can’t cast spells or take the Magic action. At the end of every 30 days, the target repeats the save, ending the effect on a success. The effect can also be ended by the Greater Restoration, Heal, or Wish spell.\nOn a successful save, the target takes half as much damage only." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Amélioration de caractéristique", en: "Enhance Ability" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une plume ou une touffe de fourrure", en: "fur or a feather" } },
    duration: { fr: "Concentration, jusqu’à 1 heure", en: "Concentration, up to 1 hour" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature et choisissez entre Force, Dextérité, Intelligence, Sagesse et Charisme. Pour toute la durée, la cible a l’Avantage aux tests de caractéristique associés à la caractéristique retenue.", en: "You touch a creature and choose Strength, Dexterity, Intelligence, Wisdom, or Charisma. For the duration, the target has Advantage on ability checks using the chosen ability." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 2e . Vous pouvez opter pour une caractéristique différente pour chaque cible.", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 2. You can choose a different ability for each target." },
    classes: ["bard","cleric","druid","ranger","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "amitie-avec-les-animaux",
    name: { fr: "Amitié avec les animaux", en: "Animal Friendship" },
    level: 1,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un peu de nourriture", en: "a morsel of food" } },
    duration: { fr: "24 heures", en: "24 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Ciblez une Bête que vous voyez à portée. La cible doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Charmé pour toute la durée du sort. Si vous ou l’un de vos alliés infligez des dégâts à la cible, le sort prend fin.", en: "Target a Beast that you can see within range. The target must succeed on a Wisdom saving throw or have the Charmed condition for the duration. If you\nor one of your allies deals damage to the target, the spells ends." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez affecter une Bête supplémentaire par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You can target one additional Beast for each spell slot level above 1." },
    classes: ["bard","druid","ranger"],
    source: 'srd-5.2.1',
  },
  {
    id: "animation-des-morts",
    name: { fr: "Animation des morts", en: "Animate Dead" },
    level: 3,
    school: "necromancy",
    castingTime: { fr: "1 minute", en: "1 minute" },
    range: { fr: "3 m", en: "10 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une goutte de sang, un morceau de chair et une pincée de poudre d’os", en: "a drop of blood, a piece of flesh, and a pinch of bone dust" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Choisissez un tas d’os ou un cadavre à portée, tiré d’un Humanoïde de taille M ou P. La cible devient un Mortvivant : un squelette si vous avez opté pour des os ou un zombi si vous avez choisi un cadavre (profil de la créature à « Monstres »). À chacun de vos tours, vous pouvez consacrer une action Bonus à donner des ordres mentaux à toute créature que vous avez créée par ce sort et qui se trouve dans un rayon de 18 m. Vous pouvez ainsi contrôler plusieurs créatures, en les choisissant, à condition de leur intimer le même ordre. Vous décidez quelle action la créature va entreprendre et où elle se déplacera à son tour suivant, ou pouvez vous contenter de donner une instruction générale, comme garder une salle ou un couloir. Sans instruction de votre part, la créature entreprend l’action Esquive et ne se déplace que pour éviter les dangers. Une fois qu’elle a reçu un ordre, la créature s’y soumet jusqu’à ce que la tâche soit accomplie. La créature reste sous votre contrôle pendant 24 heures, après quoi elle cesse d’obéir aux ordres que vous lui avez donnés. Pour en garder le contrôle pendant 24 heures de plus, vous devez relancer ce sort sur lui avant la fin des 24 heures en cours. Relancer le sort ainsi réaffirme votre emprise sur un maximum de quatre créatures que vous avez animées par ce sort, au lieu d’en animer une nouvelle.", en: "Choose a pile of bones or a corpse of a Medium or Small Humanoid within range. The target becomes an Undead creature: a Skeleton if you chose bones or a Zombie if you chose a corpse (see “Monsters” for the stat blocks).\nOn each of your turns, you can take a Bonus Action to mentally command any creature you made with this spell if the creature is within 60 feet of you (if you control multiple creatures, you can command any of them at the same time, issuing the same command to each one). You decide what action the creature will take and where it will move on its next turn, or you can issue a general command, such as to guard a chamber or corridor. If you issue no commands, the creature takes the Dodge action and moves only to avoid harm. Once given an order, the creature continues to follow it until its task is complete.\nThe creature is under your control for 24 hours, after which it stops obeying any command you’ve given it. To maintain control of the creature for another 24 hours, you must cast this spell on the creature again before the current 24-hour period ends. This use of the spell reasserts your control over up to four creatures you have animated with this spell rather than animating a new creature." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous prenez ou prolongez le contrôle de deux Morts-vivants\nsupplémentaires par niveau d’emplacement au-delà du 3e . Chacune de ces créatures doit être issue d’un tas d’os ou cadavre différent.", en: "Using a Higher-Level Spell Slot. You animate or reassert control over two additional Undead creatures for each spell slot level above 3. Each of the creatures must come from a different corpse or pile of bones." },
    classes: ["cleric","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "animation-des-objets",
    name: { fr: "Animation des objets", en: "Animate Objects" },
    level: 5,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: true, s: true, m: false },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Les objets s’animent selon vos ordres. Choisissez des objets non magiques à portée qui ne sont portés par personne, ne sont fixés à aucune surface et ne sont pas de taille Gig. Le maximum d’objets que vous pouvez animer est égal à votre modificateur de caractéristique d’incantation ; dans ce cadre, une cible de taille M ou inférieure compte pour un objet, une cible de taille G pour deux et une cible de taille TG pour trois. Chaque cible s’anime, se dote de pattes et devient un Artificiel reprenant le profil de l’objet animé ; la créature reste sous votre contrôle jusqu’à la fin du sort ou qu’elle tombe à 0 point de vie. Chaque créature ainsi créée constitue un allié pour vous et vos alliés. Au combat, elle partage votre rang d’Initiative, mais elle joue son tour juste après vous. Jusqu’à la fin du sort, vous pouvez par une action Bonus donner des ordres mentaux à toute créature que vous avez créée par ce sort et qui se trouve dans un rayon de 150 m. Vous pouvez ainsi contrôler plusieurs créatures, en les choisissant, à condition de leur intimer le même ordre. Sans instruction de votre part, la créature entreprend l’action Esquive et ne se déplace que pour éviter les dangers. Quand la créature tombe à 0 point de vie, elle retrouve sa forme de départ, tous les dégâts excédentaires étant répercutés sur celle-ci.", en: "Objects animate at your command. Choose a number of nonmagical objects within range that aren’t being worn or carried, aren’t fixed to a surface, and aren’t Gargantuan. The maximum number of objects is equal to your spellcasting ability modifier; for this number, a Medium or smaller target counts as\none object, a Large target counts as two, and a Huge target counts as three.\nEach target animates, sprouts legs, and becomes a Construct that uses the Animated Object stat block; this creature is under your control until the spell ends or until it is reduced to 0 Hit Points. Each creature you make with this spell is an ally to you and your allies. In combat, it shares your Initiative count and takes its turn immediately after yours.\nUntil the spell ends, you can take a Bonus Action to mentally command any creature you made with this spell if the creature is within 500 feet of you (if you control multiple creatures, you can command any of them at the same time, issuing the same command to each one). If you issue no commands, the creature takes the Dodge action and moves only to avoid harm. When the creature drops to 0 Hit Points, it reverts to its object form, and any remaining damage carries over to that form." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts de Coup de la créature augmentent de 1d4 (taille M ou inférieure), 1d6 (taille G) ou 1d12 (taille TG) par niveau d’emplacement au-delà du 5e . [Profil de la créature invoquée non inclus ici — voir le profil du SRD 5.2.1 ; suivi en dette D14.]", en: "Using a Higher-Level Spell Slot. The creature’s Slam damage increases by 1d4 (Medium or smaller), 1d6 (Large), or 1d12 (Huge) for each spell slot level above 5. [Summoned-creature stat block omitted here — see the SRD 5.2.1 stat block; tracked as debt D14.]" },
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "antidetection",
    name: { fr: "Antidétection", en: "Nondetection" },
    level: 3,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une pincée de poudre de diamant d’une valeur minimale de 25 po, que le sort détruit", en: "a pinch of diamond dust worth 25+ GP, which the spell consumes" } },
    duration: { fr: "8 heures", en: "8 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Pour toute la durée, vous cachez aux sorts de Divination une cible que vous touchez. La cible doit être une créature consentante, ou un lieu ou objet dont aucune dimension n’excède 3 m. Elle ne peut alors être ciblée par quelque sort de Divination que ce soit, ni perçue par des capteurs de scrutation magique.", en: "For the duration, you hide a target that you touch from Divination spells. The target can be a willing creature, or it can be a place or an object no larger than 10 feet in any dimension. The target can’t be targeted by any Divination spell or perceived through magical scrying sensors." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Apaisement des émotions", en: "Calm Emotions" },
    level: 2,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    name: { fr: "Apparence trompeuse", en: "Seeming" },
    level: 5,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  },
  {
    ...
    name: { fr: "Appel de destrier", en: "Find Steed" },
    level: 2,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous créez une arme spectrale et flottante à l’image de l’arme de votre choix, qui persiste pour toute la durée. L’arme apparaît à portée dans l’espace de votre choix et vous pouvez aussitôt effectuer une attaque de sort au corps à corps contre une créature située dans un rayon de 1,50 m de l’arme. Si l’attaque touche, la cible subit des dégâts de force égaux à 1d8 + votre modificateur de caractéristique d’incantation. Par une action Bonus à chaque tour consécutif, vous pouvez déplacer l’arme d’un maximum de 6 m et répéter l’attaque contre une créature située dans un rayon de 1,50 m de l’arme.", en: "You create a floating, spectral force that resembles a weapon of your choice and lasts for the duration. The force appears within range in a space of your choice, and you can immediately make one melee spell attack against one creature within 5 feet of the force. On a hit, the target takes Force damage equal to 1d8 plus your spellcasting ability modifier.\nAs a Bonus Action on your later turns, you can move the force up to 20 feet and repeat the attack against a creature within 5 feet of it." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for every slot level above 2." },
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  {
    id: "armure-du-mage",
    name: { fr: "Armure du mage", en: "Mage Armor" },
    level: 1,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "un morceau de cuir traité", en: "a piece of cured leather" } },
    duration: { fr: "8 heures", en: "8 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez une créature consentante qui ne porte pas d’armure. Jusqu’à la fin du sort, sa CA de base est de 13 plus son modificateur de Dextérité. Le sort prend fin prématurément si la cible enfile une armure.", en: "You touch a willing creature who isn’t wearing armor. Until the spell ends, the target’s base AC becomes 13 plus its Dexterity modifier. The spell ends early if the target dons armor." },
    atHigherLevels: null,
  ...
  {
    id: "arret-du-temps",
    name: { fr: "Arrêt du temps", en: "Time Stop" },
    level: 9,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
  ...
  {
    id: "aspersion-acide",
    name: { fr: "Aspersion acide", en: "Acid Splash" },
    level: 0,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous créez une bulle acide en un point à portée, où elle explose sous forme de Sphère de 1,50 m de rayon. Chaque créature prise dans la Sphère doit réussir un jet de sauvegarde de Dextérité sous peine de subir 1d6 dégâts d’acide.", en: "You create an acidic bubble at a point within range, where it explodes in a 5-foot-radius Sphere. Each creature in that Sphere must succeed on a Dexterity saving throw or take 1d6 Acid damage." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Les dégâts augmentent de 1d6 lorsque vous atteignez les niveaux 5 (2d6), 11 (3d6) et 17 (4d6).", en: "Cantrip Upgrade. The damage increases by 1d6 when you reach levels 5 (2d6), 11 (3d6), and 17 (4d6)." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "assassin-imaginaire",
    name: { fr: "Assassin imaginaire", en: "Phantasmal Killer" },
    level: 4,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous puisez dans les cauchemars d’une créature que vous voyez à portée pour créer une illusion de ses plus grandes craintes, visible uniquement de la créature. La cible effectue un jet de sauvegarde de Sagesse. En cas d’échec, la cible subit 4d10 dégâts psychiques, ainsi que le Désavantage aux tests de caractéristique et aux jets d’attaque pour toute la durée. En cas de réussite, la cible subit la moitié de ces dégâts et le sort prend fin. Pour toute la durée, la cible effectue un JS Sagesse à la fin de chacun de ses tours. En cas d’échec, elle subit de nouveau les dégâts psychiques. En cas de réussite, le sort prend fin.", en: "You tap into the nightmares of a creature you can see within range and create an illusion of its deepest fears, visible only to that creature. The target makes a Wisdom saving throw. On a failed save, the target takes 4d10 Psychic damage and has Disadvantage on ability checks and attack rolls for the duration. On a successful save, the target takes half as much damage, and the spell ends.\nFor the duration, the target makes a Wisdom saving throw at the end of each of its turns. On a failed save, it takes the Psychic damage again. On a successful save, the spell ends." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d10 par niveau d’emplacement au-delà du 4e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d10 for each spell slot level above 4." },
    classes: ["bard","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "assistance",
    name: { fr: "Assistance", en: "Guidance" },
    level: 0,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature consentante en choisissant une compétence. Jusqu’à la fin du sort, la créature ajoute 1d4 au résultat de tout test de caractéristique associé à cette compétence.", en: "You touch a willing creature and choose a skill. Until the spell ends, the creature adds 1d4 to any ability check using the chosen skill." },
    atHigherLevels: null,
  ...
  {
    id: "augure",
    name: { fr: "Augure", en: "Augury" },
    level: 2,
    school: "divination",
    castingTime: { fr: "1 minute ou rituel", en: "1 minute or Ritual" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "cartes, os ou bâtonnets gra- vés spécialement, ou objets divinatoires comparables, d’une valeur minimale de 25 po", en: "specially marked sticks, bones, cards, or other divinatory tokens worth 25+ GP" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: true,
    description: { fr: "Vous recevez un présage d’une entité surnaturelle vous renseignant sur l’issue d’une opération que vous comptez mener dans les 30 minutes. Le MJ choisit une option de la table Présages : Présages PrésagePour une issue qui s’annonce... Fortunefavorable Misèredéfavorable Fortune et misère favorable et défavorable Indifférenceni favorable ni défavorable Le sort ne tient pas compte des conjonctures qui pourraient peser dans la balance, comme l’incantation de nouveaux sorts. Si vous lancez le sort plus d’une fois avant de terminer votre prochain Repos long, vous courez dès la deuxième incantation 25 % de risques cumulatifs qu’il ne vous livre aucune réponse.", en: "You receive an omen from an otherworldly entity about the results of a course of action that you plan to take within the next 30 minutes. The GM chooses the omen from the Omens table. Omens OmenFor Results That Will Be ... WealGood WoeBad Weal and woeGood and bad IndifferenceNeither good nor bad The spell doesn’t account for circumstances, such as other spells, that might change the results. If you cast the spell more than once before finishing a Long Rest, there is a cumulative 25 percent chance for each casting after the first that you get no a ns wer." },
    atHigherLevels: null,
  ...
  {
    id: "aura-de-vie",
    name: { fr: "Aura de vie", en: "Aura of Life" },
    level: 4,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Une aura rayonne depuis vous pour toute la durée, sous forme d’une Émanation de 9 m. Toute créature alliée comprise dans l’aura (y compris vous) bénéficie de la Résistance aux dégâts nécrotiques et rien ne peut réduire son maximum de points de vie. Si un allié à 0 point de vie commence son tour dans l’aura, il récupère 1 point de vie.", en: "An aura radiates from you in a 30-foot Emanation for the duration. While in the aura, you and your allies have Resistance to Necrotic damage, and your Hit Point maximums can’t be reduced. If an ally with 0 Hit Points starts its turn in the aura, that ally regains 1 Hit Point." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Aura magique de l’arcaniste", en: "Arcanist’s Magic Aura" },
    level: 2,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "un petit carré de soie", en: "a small square of silk" } },
    duration: { fr: "24 heures", en: "24 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "D’un contact, vous placez une illusion sur une créature consentante ou un objet qui n’est porté par personne. Une créature reçoit l’effet Masque, tandis qu’un objet reçoit l’effet Aura factice (voir plus loin). Les effets persistent pour toute la durée. Si vous lancez ce sort sur une même créature ou un même objet pendant 30 jours consécutifs, l’illusion persiste jusqu’à dissipation. Masque (créature). Choisissez un type de créature autre que celui de la cible. Les sorts et effets magiques considèrent désormais la cible comme du type retenu. Aura factice (objet). Vous altérez la manière dont la cible se dévoile au gré de sorts et effets magiques qui perçoivent les auras magiques, tels que détection de la magie. Vous pouvez ainsi faire qu’un objet ordinaire paraisse magique, qu’un objet magique paraisse ordinaire, ou modifier l’aura magique d’un objet pour qu’elle soit associée à l’école de magie de votre choix.", en: "With a touch, you place an illusion on a willing creature or an object that isn’t being worn or carried. A creature gains the Mask effect below, and an object gains the False Aura effect below. The effect lasts for the duration. If you cast the spell on the same target every day for 30 days, the illusion lasts until dispelled. Mask (Creature). Choose a creature type other than the target’s actual type. Spells and other magical effects treat the target as if it were a creature of the chosen type.\nFalse Aura (Object). You change the way the target appears to spells and magical effects that detect magical auras, such as Detect Magic. You can make a nonmagical object appear magical, make a magic item appear nonmagical, or change the object’s aura so that it appears to belong to a school of magic you choose." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "aura-sacree",
    name: { fr: "Aura sacrée", en: "Holy Aura" },
    level: 8,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "un reliquaire d’une valeur mini- male de 1 000 po", en: "a reliquary worth 1,000+ GP" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Pour toute la durée, vous émettez une aura sous forme d’une Émanation de 9 m. Tant qu’elles sont dans l’aura, les créatures que vous choisissez ont l’Avantage aux jets de sauvegarde et les autres ont contre elle le Désavantage aux jets d’attaque. De plus, lorsqu’un Fiélon ou un Mort-vivant touche une créature affectée avec un jet d’attaque de corps à corps, l’assaillant doit réussir un jet de sauvegarde de Constitution sous peine de subir l’état Aveuglé jusqu’à la fin de son tour suivant.", en: "For the duration, you emit an aura in a 30-foot Emanation. While in the aura, creatures of your choice have Advantage on all saving throws, and other creatures have Disadvantage on attack rolls against them. In addition, when a Fiend or an Undead hits an affected creature with a melee attack roll, the attacker must succeed on a Constitution saving throw or have the Blinded condition until the end of its next turn." },
    atHigherLevels: null,
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Baies nourricières", en: "Goodberry" },
    level: 1,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une branche de gui", en: "a sprig of mistletoe" } },
    duration: { fr: "24 heures", en: "24 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Dix baies se matérialisent dans votre main, gorgées de magie pour toute la durée. Une créature peut manger l’une de ces baies par une action Bonus. L’ingestion d’une baie fait récupérer 1 point de vie et fournit l’équivalent d’une journée de sustentation pour une créature. Les baies non consommées disparaissent quand le sort prend fin.", en: "Ten berries appear in your hand and are infused with magic for the duration. A creature can take a Bonus Action to eat one berry. Eating a berry restores 1 Hit Point, and the berry provides enough nourishment to sustain a creature for one day.\nUneaten berries disappear when the spell ends." },
    atHigherLevels: null,
  ...
  {
    id: "benediction",
    name: { fr: "Bénédiction", en: "Bless" },
    level: 1,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un symbole sacré d’une valeur minimale de 5 po", en: "a Holy Symbol worth 5+ GP" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous bénissez jusqu’à trois créatures à portée. Chaque fois qu’une de ces cibles effectue un jet d’attaque ou un jet de sauvegarde avant la fin du sort, elle ajoute 1d4 au résultat correspondant.", en: "You bless up to three creatures within range. Whenever a target makes an attack roll or a saving throw before the spell ends, the target adds 1d4 to the attack roll or save." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 1." },
    classes: ["cleric","paladin"],
    source: 'srd-5.2.1',
  },
  {
    id: "blessure",
    name: { fr: "Blessure", en: "Inflict Wounds" },
    level: 1,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "La créature que vous touchez physiquement effectue un jet de sauvegarde de Constitution et subit 2d10 dégâts nécrotiques en cas d’échec, la moitié en cas de réussite.", en: "A creature you touch makes a Constitution saving throw, taking 2d10 Necrotic damage on a failed save or half as much damage on a successful one." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d10 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d10 for each spell slot level above 1." },
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  {
    id: "bouche-magique",
    name: { fr: "Bouche magique", en: "Magic Mouth" },
    level: 2,
    school: "illusion",
    castingTime: { fr: "1 minute ou rituel", en: "1 minute or Ritual" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "poudre de jade d’une valeur minimale de 10 po, que le sort détruit", en: "jade dust worth 10+ GP, which the spell consumes" } },
    duration: { fr: "jusqu’à dissipation", en: "Until dispelled" },
    concentration: false,
    ritual: true,
    description: { fr: "Vous chargez un objet à portée d’un message qui sera prononcé lorsqu’une condition de déclenchement se présentera. Choisissez un objet que vous voyez et qui n’est pas porté par une autre créature. Prononcez alors un message d’un maximum de 25 mots (vous disposez toutefois de 10 minutes pour le peaufiner). Enfin, déterminez les circonstances qui déclencheront la transmission du message par le sort. Quand cette condition se présente, une bouche magique apparaît sur l’objet et récite le message avec votre voix, au même volume que vous. Si l’objet choisi est lui-même doté d’une ouverture qui peut passer pour une bouche (comme sur une statue d’humanoïde), la bouche magique s’y manifeste et les mots semblent en émaner. À l’incantation du sort, vous pouvez décider que le sort prenne fin après avoir livré son message ou qu’il reste en place et répète son annonce chaque fois que le déclencheur se présente. Les circonstances de déclenchement peuvent être générales ou détaillées, à votre convenance, mais doivent correspondre à des conditions visuelles ou auditives intervenant dans un rayon de 9 m de l’objet. Vous pourriez ainsi statuer que la bouche s’exprime quand une créature s’approche à 9 m ou moins de l’objet ou quand une cloche d’argent sonne dans ce même rayon.", en: "You implant a message within an object in range—a message that is uttered when a trigger condition is met. Choose an object that you can see and that isn’t being worn or carried by another creature. Then speak the message, which must be 25 words or fewer, though it can be delivered over as long as 10 minutes. Finally, determine the circumstance that will trigger the spell to deliver your message.\nWhen that trigger occurs, a magical mouth appears on the object and recites the message in your voice and at the same volume you spoke. If the object you chose has a mouth or something that looks like a mouth (for example, the mouth of a statue), the magical mouth appears there, so the words appear to come from the object’s mouth. When you cast this spell, you can have the spell end after it delivers its message, or it can remain and repeat its message whenever the trigger occurs.\nThe trigger can be as general or as detailed as you like, though it must be based on visual or audible conditions that occur within 30 feet of the object. For example, you could instruct the mouth to speak when any creature moves within 30 feet of the object or when a silver bell rings within 30 feet of it." },
    atHigherLevels: null,
    classes: ["bard","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    level: 1,
    school: "abjuration",
    castingTime: { fr: "Réaction, que vous jouez lors- qu’un jet d’attaque vous touche ou que le sort projectile magique vous cible", en: "Reaction, which you take when you are hit by an attack roll or targeted by the Magic Missile spell" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: false },
    duration: { fr: "1 round", en: "1 round" },
    concentration: false,
    ritual: false,
    description: { fr: "Une barrière imperceptible de force magique vous protège. Jusqu’au début de votre tour suivant, vous recevez un bonus de +5 à la CA, y compris contre l’attaque qui a déclenché le sort, et vous ne subissez aucun dégât de projectile magique.", en: "An imperceptible barrier of magical force protects you. Until the start of your next turn, you have a +5\nbonus to AC, including against the triggering attack, and you take no damage from Magic Missile." },
    atHigherLevels: null,
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "bouclier-de-feu",
    name: { fr: "Bouclier de feu", en: "Fire Shield" },
    level: 4,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "un peu de phosphore ou une luciole", en: "a bit of phosphorus or a firefly" } },
    duration: { fr: "10 minutes", en: "10 minutes" },
    concentration: false,
    ritual: false,
    description: { fr: "Des flammes ondoyantes vous enveloppent pour toute la durée en produisant une Lumière vive dans un rayon de 3 m et une Lumière faible sur 3 m de plus. Les flammes vous procurent un écran chaud ou frais, à votre convenance. Un écran chaud vous octroie la Résistance aux dégâts de froid, un écran frais la Résistance aux dégâts de feu. De plus, chaque fois qu’une créature située dans un rayon de 1,50 m de vous vous touche avec un jet d’attaque de corps à corps, les flammes s’attisent brusquement. L’assaillant subit 2d8 dégâts de feu si l’écran est chaud, 2d8 dégâts de froid s’il est frais.", en: "Wispy flames wreathe your body for the duration, shedding Bright Light in a 10-foot radius and Dim Light for an additional 10 feet. The flames provide you with a warm shield or a chill shield, as you choose. The warm shield grants you Resistance to Cold damage, and the chill shield grants you Resistance to Fire damage.\nIn addition, whenever a creature within 5 feet of you hits you with a melee attack roll, the shield erupts with flame. The attacker takes 2d8 Fire damage from a warm shield or 2d8 Cold damage from a chill shield." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Bouclier de la foi", en: "Shield of Faith" },
    level: 1,
    school: "abjuration",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un parchemin de prière", en: "a prayer scroll" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: false,
    description: { fr: "Un champ scintillant enveloppe une créature de votre choix à portée et lui octroie un bonus de +2 à la CA pour toute la durée.", en: "A shimmering field surrounds a creature of your choice within range, granting it a +2 bonus to AC for the duration." },
    atHigherLevels: null,
    classes: ["cleric","paladin"],
    source: 'srd-5.2.1',
  },
  {
    id: "bouffee-de-poison",
    name: { fr: "Bouffée de poison", en: "Poison Spray" },
    level: 0,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous projetez une brume toxique vers une créature à portée. Effectuez une attaque de sort à distance contre la cible. Si l’attaque touche, la cible subit 1d12 dégâts de poison.", en: "You spray toxic mist at a creature within range. Make a ranged spell attack against the target. On a hit, the target takes 1d12 Poison damage." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Les dégâts augmentent de 1d12 lorsque vous atteignez les niveaux 5 (2d12), 11 (3d12) et 17 (4d12).", en: "Cantrip Upgrade. The damage increases by 1d12 when you reach levels 5 (2d12), 11 (3d12), and 17 (4d12)." },
  ...
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "45 m", en: "150 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une boulette de guano de chauve-souris et de soufre", en: "a ball of bat guano and sulfur" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Une zébrure éblouissante jaillit de vous jusqu’au point que vous choisissez à portée, produisant une déflagration au grondement sourd. Chaque créature prise dans la Sphère de 6 m de rayon centrée sur ce point d’origine effectue un jet de sauvegarde de Dextérité et subit 8d6 dégâts de feu en cas d’échec, la moitié en cas de réussite. L’explosion embrase les objets inflammables de la zone qui ne sont portés par personne.", en: "A bright streak flashes from you to a point you choose within range and then blossoms with a low roar into a fiery explosion. Each creature in a 20-foot-radius Sphere centered on that point makes a Dexterity saving throw, taking 8d6 Fire damage on a failed save or half as much damage on a successful one.\nFlammable objects in the area that aren’t being worn or carried start burning." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d6 par niveau d’emplacement au-delà du 3e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d6 for each spell slot level above 3." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "boule-de-feu-a-retardement",
    name: { fr: "Boule de feu à retardement", en: "Delayed Blast Fireball" },
    level: 7,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "45 m", en: "150 feet" },
  ...
  {
    id: "brume-mortelle",
    name: { fr: "Brume mortelle", en: "Cloudkill" },
    level: 5,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
  ...
  },
  {
    ...
    name: { fr: "Caresse du vampire", en: "Vampiric Touch" },
    level: 3,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  {
    id: "cecite-surdite",
    name: { fr: "Cécité/surdité", en: "Blindness/Deafness" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une créature que vous voyez à portée doit réussir un jet de sauvegarde de Constitution, sous peine de subir l’état Assourdi ou Aveuglé (vous choisissez) pour toute la durée. La cible réitère le JS à la fin de chacun de ses tours et met un terme au sort sur elle-même en cas de réussite.", en: "One creature that you can see within range must succeed on a Constitution saving throw, or it has the Blinded or Deafened condition (your choice) for the duration. At the end of each of its turns, the target repeats the save, ending the spell on itself on a success." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 2." },
    classes: ["bard","cleric","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "cercle-de-mort",
    name: { fr: "Cercle de mort", en: "Circle of Death" },
    level: 6,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "45 m", en: "150 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une perle noire d’une valeur minimale de 500 po réduite en poudre", en: "the powder of a crushed black pearl worth 500+ GP" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Des ondes d’énergie négative rayonnent sous forme d’une Sphère de 18 m de rayon centrée sur un point que vous choisissez à portée. Chaque créature prise dans la zone effectue un jet de sauvegarde de Constitution et subit 8d8 dégâts nécrotiques en cas d’échec, la moitié en cas de réussite.", en: "Negative energy ripples out in a 60-foot-radius Sphere from a point you choose within range. Each creature in that area makes a Constitution saving throw, taking 8d8 Necrotic damage on a failed save or half as much damage on a successful one." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 2d8 par niveau d’emplacement au-delà du 6e .", en: "Using a Higher-Level Spell Slot. The damage increases by 2d8 for each spell slot level above 6." },
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "cercle-de-teleportation",
    name: { fr: "Cercle de téléportation", en: "Teleportation Circle" },
    level: 5,
    school: "conjuration",
    castingTime: { fr: "1 minute", en: "1 minute" },
    range: { fr: "3 m", en: "10 feet" },
    components: { v: true, s: false, m: true, material: { fr: "encres rares d’une valeur minimale de 50 po, que le sort détruit", en: "rare inks worth 50+ GP, which the spell consumes" } },
    duration: { fr: "1 round", en: "1 round" },
    concentration: false,
    ritual: false,
    description: { fr: "À l’incantation du sort, vous tracez un cercle de 1,50 m de diamètre au sol, composé de symboles qui relient votre emplacement à un cercle de téléportation permanent de votre choix dont vous connaissez la séquence de runes et situé sur le même plan d’existence que vous. Un portail chatoyant s’ouvre au sein du cercle ainsi tracé et reste ouvert jusqu’à la fin de votre tour suivant. Toute créature qui pénètre dans le portail apparaît aussitôt dans un rayon de 1,50 m du cercle de destination ou, si cet espace n’est pas libre, dans l’espace inoccupé le plus proche. De nombreux temples et guildes importants disposent d’un cercle de téléportation permanent dans leurs locaux. Chaque cercle comprend toujours sa propre séquence de runes, une suite de symboles à l’agencement unique. La première fois que vous acquérez la faculté de lancer ce sort, vous apprenez la séquence de runes de deux destinations du Plan Matériel, déterminées par le MJ. Vous y ajouterez éventuellement d’autres séquences au fil de vos aventures. Graver une nouvelle séquence de runes dans votre mémoire nécessite de l’étudier pendant 1 minute. Vous pouvez créer un cercle de téléportation permanent en lançant quotidiennement ce sort au même endroit pendant 365 jours.", en: "As you cast the spell, you draw a 5-foot-radius circle on the ground inscribed with sigils that link your location to a permanent teleportation circle of your choice whose sigil sequence you know and that is on the same plane of existence as you. A shimmering portal opens within the circle you drew and remains open until the end of your next turn. Any creature that enters the portal instantly appears within 5 feet of the destination circle or in the nearest unoccupied space if that space is occupied.\nMany major temples, guildhalls, and other important places have permanent teleportation circles. Each circle includes a unique sigil sequence—a string of runes arranged in a particular pattern. When you first gain the ability to cast this spell, you learn the sigil sequences for two destinations on the Material Plane, determined by the GM. You might learn additional sigil sequences during your adventures. You can commit a new sigil sequence to memory after studying it for 1 minute.\nYou can create a permanent teleportation circle by casting this spell in the same location every day for 365 days." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Changement de plan", en: "Plane Shift" },
    level: 7,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une badine métallique fourchue d’une valeur minimale de 250 po, accordée avec un plan d’existence.", en: "a forked, metal rod worth 250+ GP and attuned to a plane of existence" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous et un maximum de huit créatures consentantes avec lesquelles vous formez un cercle en vous tenant par la main êtes transportés sur un autre plan d’existence. Vous pouvez spécifier une destination en des termes généraux, comme une cité donnée du Plan Élémentaire du Feu ou un palais précis sur la deuxième strate des Neuf Enfers, auquel cas vous apparaissez à destination ou à proximité (à l’appréciation du MJ). Ou bien, si vous connaissez la séquence de runes d’un cercle de téléportation sur un autre plan d’existence, ce sort vous transporte directement dans le cercle. Si le cercle de téléportation est trop petit pour accueillir toutes les créatures transportées, elles apparaissent dans les espaces inoccupés les plus proches du cercle.", en: "You and up to eight willing creatures who link hands in a circle are transported to a different plane of existence. You can specify a target destination in general terms, such as a specific city on the Elemental Plane of Fire or palace on the second level of the Nine Hells, and you appear in or near that destination, as determined by the GM.\nAlternatively, if you know the sigil sequence of a teleportation circle on another plane of existence, this spell can take you to that circle. If the teleportation circle is too small to hold all the creatures you transported, they appear in the closest unoccupied spaces next to the circle." },
    atHigherLevels: null,
  ...
  {
    id: "charme-monstre",
    name: { fr: "Charme-monstre", en: "Charm Monster" },
    level: 4,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une créature que vous voyez à portée effectue un jet de sauvegarde de Sagesse. Ce jet s’effectue avec l’Avantage si vous ou vos alliés êtes en train de l’affronter. En cas d’échec, la cible subit l’état Charmé jusqu’à la fin du sort ou que vous ou vos alliés lui infligiez des dégâts. La créature ainsi Charmée vous est Amicale. Lorsque le sort prend fin, la cible sait que vous l’avez Charmée.", en: "One creature you can see within range makes a Wisdom saving throw. It does so with Advantage if you or your allies are fighting it. On a failed save, the target has the Charmed condition until the spell ends or until you or your allies damage it. The Charmed creature is Friendly to you. When the spell ends, the target knows it was Charmed by you." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 4e .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 4." },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Un Humanoïde que vous voyez à portée effectue un jet de sauvegarde de Sagesse. Ce jet s’effectue avec l’Avantage si vous ou vos alliés êtes en train de l’affronter. En cas d’échec, la cible subit l’état Charmé jusqu’à la fin du sort ou que vous ou vos alliés lui infligiez des dégâts. La créature ainsi Charmée vous est Amicale. Lorsque le sort prend fin, la cible sait que vous l’avez Charmée.", en: "One Humanoid you can see within range makes a Wisdom saving throw. It does so with Advantage if you or your allies are fighting it. On a failed save, the target has the Charmed condition until the spell ends or until you or your allies damage it. The Charmed creature is Friendly to you. When the spell ends, the target knows it was Charmed by you." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 1." },
    classes: ["bard","druid","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "chatiment-de-fournaise",
    name: { fr: "Châtiment de fournaise", en: "Searing Smite" },
    level: 1,
    school: "evocation",
    castingTime: { fr: "action Bonus, que vous entre- prenez aussitôt après avoir touché une cible avec une arme de corps à corps ou à mains nues", en: "Bonus Action, which you take immedi- ately after hitting a target with a Melee weapon or an Unarmed Strike" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: false, m: false },
    duration: { fr: "1 minute", en: "1 minute" },
    concentration: false,
    ritual: false,
    description: { fr: "Alors que vous touchez la cible, elle subit 1d6 dégâts de feu supplémentaires de l’attaque. Au début de chacun de ses tours jusqu’à la fin du sort, la cible subit 1d6 dégâts de feu et effectue un jet de sauvegarde de\nConstitution. En cas d’échec, le sort se poursuit. En cas de réussite, le sort prend fin.", en: "As you hit the target, it takes an extra 1d6 Fire damage from the attack. At the start of each of its turns until the spell ends, the target takes 1d6 Fire damage and then makes a Constitution saving throw. On a failed save, the spell continues. On a successful save, the spell ends." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Tous les dégâts augmentent de 1d6 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. All the damage increases by 1d6 for each spell slot level above 1." },
    classes: ["paladin"],
    source: 'srd-5.2.1',
  },
  {
    id: "chatiment-de-revelation",
    name: { fr: "Châtiment de révélation", en: "Shining Smite" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action Bonus, que vous entrepre- nez aussitôt après avoir touché une créature avec une arme de corps à corps ou une attaque à mains nues", en: "Bonus Action, which you take immedi- ately after hitting a creature with a Melee weapon or an Unarmed Strike" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: false, m: false },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "La cible touchée par l’attaque subit 2d6 dégâts radiants supplémentaires. Jusqu’à la fin du sort, la cible émet une Lumière vive dans un rayon de 1,50 m, les jets d’attaque contre elle ont l’Avantage et elle ne peut pas bénéficier de l’état Invisible.", en: "The target hit by the strike takes an extra 2d6 Radiant damage from the attack. Until the spell ends, the target sheds Bright Light in a 5-foot radius, attack rolls against it have Advantage, and it can’t benefit from the Invisible condition." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d6 par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d6 for each spell slot level above 2." },
    classes: ["paladin"],
    source: 'srd-5.2.1',
  },
  {
    id: "chatiment-divin",
    name: { fr: "Châtiment divin", en: "Divine Smite" },
    level: 1,
    school: "evocation",
    castingTime: { fr: "action Bonus, que vous entre- prenez aussitôt après avoir touché une cible avec une arme de corps à corps ou à mains nues", en: "Bonus Action, which you take immedi- ately after hitting a target with a Melee weapon or an Unarmed Strike" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "L’attaque inflige à la cible 2d8 dégâts radiants supplémentaires. Ces dégâts supplémentaires augmentent de 1d8 si la cible est un Fiélon ou un Mort-vivant.", en: "The target takes an extra 2d8 Radiant damage from the attack. The damage increases by 1d8 if the target is a Fiend or an Undead." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for each spell slot level above 1." },
    classes: ["paladin"],
    source: 'srd-5.2.1',
  },
  {
    id: "chien-de-garde",
    name: { fr: "Chien de garde", en: "Faithful Hound" },
    level: 4,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un sifflet en argent", en: "a silver whistle" } },
    duration: { fr: "8 heures", en: "8 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous invoquez un chien de garde fantomatique en un espace inoccupé que vous voyez à portée. Le molosse reste pour toute la durée (il disparaît toutefois si vous et lui vous retrouvez éloignés de plus de 90 m). En dehors de vous, personne ne voit le chien de garde, qui est à la fois intangible et invulnérable. Quand une créature de taille S ou supérieure s’approche dans un rayon de 9 m de lui sans prononcer au préalable le mot de passe que vous avez spécifié à l’incantation du sort, le chien se met à aboyer furieusement. Le molosse est doté de la Vision lucide avec une portée de 9 m. Au début de chacun de vos tours, le molosse tente de mordre un ennemi situé dans un rayon de 1,50 m de lui. Cet ennemi doit réussir un jet de sauvegarde de Dextérité sous peine de subir 4d8 dégâts de force. À vos tours suivants, vous pouvez entreprendre l’action Magie pour déplacer le molosse d’un maximum de 9 m.", en: "You conjure a phantom watchdog in an unoccupied space that you can see within range. The hound remains for the duration or until the two of you are more than 300 feet apart from each other.\nNo one but you can see the hound, and it is intangible and invulnerable. When a Small or larger creature comes within 30 feet of it without first speaking the password that you specify when you cast this spell, the hound starts barking loudly. The hound has Truesight with a range of 30 feet.\nAt the start of each of your turns, the hound attempts to bite one enemy within 5 feet of it. That enemy must succeed on a Dexterity saving throw or take 4d8 Force damage.\nOn your later turns, you can take a Magic action to move the hound up to 30 feet." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "clone",
    name: { fr: "Clone", en: "Clone" },
    level: 8,
    school: "necromancy",
    castingTime: { fr: "1 heure", en: "1 hour" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "un diamant d’une valeur mini- male de 1 000 po que le sort détruit et un récipient d’une valeur minimale de 2 000 po, assez grand pour contenir la créature à cloner", en: "a diamond worth 1,000+ GP, which the spell consumes, and a sealable vessel worth 2,000+ GP that is large enough to hold the creature being cloned" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature ou au moins 15 cm 3 de sa chair. Une réplique inerte se forme à l’intérieur d’un récipient utilisé pour l’incantation, sa croissance jusqu’à maturité demandant 120 jours. Vous décidez si le clone est une version plus jeune de la créature ou du même âge. Le clone reste inerte et immarcescible tant que le récipient n’est pas endommagé. Si, une fois le clone formé, la créature d’origine meurt, son âme (à condition qu’elle soit libre et consentante) est transférée dans le clone. Le clone est identique à l’original sur le plan physique et présente la même personnalité ; ses souvenirs sont les mêmes, ainsi que ses caractéristiques, mais il ne récupère rien de l’équipement de la créature clonée. La dépouille du cloné, si elle existe, devient inerte et ne pourra être ramenée à la vie, étant donné que l’âme de la créature est ailleurs.", en: "You touch a creature or at least 1 cubic inch of its flesh. An inert duplicate of that creature forms inside the vessel used in the spell’s casting and finishes growing after 120 days; you choose whether the finished clone is the same age as the creature or younger. The clone remains inert and endures indefinitely while its vessel remains undisturbed. If the original creature dies after the clone finishes forming, the creature’s soul transfers to the clone if the soul is free and willing to return. The clone is physically identical to the original and has the same personality, memories, and abilities, but none of the original’s equipment. The creature’s original remains, if any, become inert and can’t be revived, since the creature’s soul is elsewhere." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "coffre-secret",
    name: { fr: "Coffre secret", en: "Secret Chest" },
    level: 4,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "un coffre de 90 cm par 60 et 60, fait de matériaux rares d’une valeur minimale de 5 000 po, et sa réplique de taille TP faite des mêmes matériaux d’une valeur minimale de 50 po", en: "a chest, 3 feet by 2 feet by 2 feet, constructed from rare materials worth 5,000+ GP, and a Tiny replica of the chest made from the same materi- als worth 50+ GP" } },
    duration: { fr: "jusqu’à dissipation", en: "Until dispelled" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous cachez un coffre et son contenu sur le Plan Éthéré. Vous devez toucher le coffre et la réplique miniature qui sert de composante matérielle pour le sort. Le coffre peut renfermer un maximum de 0,3 m 3\nde matière non vivante (90 x 60 x 60 cm). Tant que le coffre reste sur le Plan Éthéré, vous pouvez entreprendre l’action Magie pour toucher la réplique et rappeler le coffre. Il réapparaît au sol, en un espace inoccupé dans un rayon de 1,50 m de vous. Vous pouvez le renvoyer sur le Plan Éthéré au prix de l’action Magie, en touchant simultanément le coffre et sa réplique. Au bout de 60 jours, 5 % de risque s’accumulent chaque jour que le sort prenne fin. Le sort prend aussi fin si vous le relancez ou si la réplique de taille TP est détruite. Si le sort prend fin alors que le grand coffre se trouve sur le Plan Éthéré, celui-ci reste sur ce plan en attendant d’être retrouvé.", en: "You hide a chest and all its contents on the Ethereal Plane. You must touch the chest and the miniature replica that serve as Material components for the spell. The chest can contain up to 12 cubic feet of nonliving material (3 feet by 2 feet by 2 feet).\nWhile the chest remains on the Ethereal Plane, you can take a Magic action and touch the replica to recall the chest. It appears in an unoccupied space on the ground within 5 feet of you. You can send the chest back to the Ethereal Plane by taking a Magic action to touch the chest and the replica.\nAfter 60 days, there is a cumulative 5 percent chance at the end of each day that the spell ends. The spell also ends if you cast this spell again or if the Tiny replica chest is destroyed. If the spell ends and the larger chest is on the Ethereal Plane, the chest remains there for you or someone else to find." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Colonne de flamme", en: "Flame Strike" },
    level: 5,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une pincée de soufre", en: "a pinch of sulfur" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Une colonne verticale de flammes radieuses surgit des hauteurs. Chaque créature prise dans un Cylindre d’un rayon de 3 m, haut de 12 m et centré sur un point à portée effectue un jet de sauvegarde de Dextérité. Elle subit 5d6 dégâts de feu et 5d6 dégâts radiants en cas d’échec, la moitié en cas de réussite.", en: "A vertical column of brilliant fire roars down from above. Each creature in a 10-foot-radius, 40-foothigh Cylinder centered on a point within range makes a Dexterity saving throw, taking 5d6 Fire damage and 5d6 Radiant damage on a failed save or half as much damage on a successful one." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts de feu et les dégâts radiants augmentent chacun de 1d6 par niveau d’emplacement au-delà du 5e .", en: "Using a Higher-Level Spell Slot. The Fire damage and the Radiant damage increase by 1d6 for each spell slot level above 5." },
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  {
    id: "communication-a-distance",
    name: { fr: "Communication à distance", en: "Sending" },
    level: 3,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "illimitée", en: "Unlimited" },
    components: { v: true, s: true, m: true, material: { fr: "du fil de cuivre", en: "a copper wire" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous envoyez un bref message n’excédant pas 25 mots à une créature que vous avez rencontrée (ou qu’une personne qui l’a rencontrée vous a décrite). L’esprit de la cible perçoit le message, celle-ci vous identifie comme expéditeur si elle vous connaît et peut vous répondre aussitôt dans le même mode. Le sort permet aux cibles de comprendre le sens de votre message. La distance qui vous sépare du destinataire n’a pas d’importance et vous pouvez même atteindre d’autres plans d’existence, mais si la cible se trouve sur un plan différent, il y a 5 % de chance pour que le message n’aboutisse pas. Si la transmission ne s’est pas faite, vous le savez. À la réception du message, la créature peut vous empêcher de la recontacter par ce sort pour les 8 prochaines heures. Si vous tentez de lui envoyer un autre message dans cet intervalle, vous savez qu’elle vous a bloqué et le sort échoue.", en: "You send a short message of 25 words or fewer to a creature you have met or a creature described to you by someone who has met it. The target hears the message in its mind, recognizes you as the sender if it knows you, and can answer in a like manner immediately. The spell enables targets to understand the meaning of your message.\nYou can send the message across any distance and even to other planes of existence, but if the target is on a different plane than you, there is a 5 percent chance that the message doesn’t arrive. You know if the delivery fails.\nUpon receiving your message, a creature can block your ability to reach it again with this spell for 8 hours. If you try to send another message during that time, you learn that you are blocked, and the spell fails." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    level: 1,
    school: "divination",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: false },
    duration: { fr: "10 minutes", en: "10 minutes" },
    concentration: false,
    ritual: true,
    description: { fr: "Pour toute la durée, vous avez la faculté de comprendre les Bêtes et de communiquer verbalement avec elles, et toutes les options de compétence de l’action Influence vous sont accessibles avec elles. La plupart des Bêtes ont peu à dire au-delà des sujets de survie et d’affection, mais toutes sont capables de vous informer sur les environs et les monstres locaux, notamment ce qu’elles ont perçu au cours de la dernière journée.", en: "For the duration, you can comprehend and verbally communicate with Beasts, and you can use any of the Influence action’s skill options with them.\nMost Beasts have little to say about topics that don’t pertain to survival or companionship, but at minimum, a Beast can give you information about nearby locations and monsters, including whatever it has perceived within the past day." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Communication avec les plantes", en: "Speak with Plants" },
    level: 3,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    name: { fr: "Communion avec la nature", en: "Commune with Nature" },
    level: 5,
    school: "divination",
    castingTime: { fr: "1 minute ou rituel", en: "1 minute or Ritual" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une pincée de suie et de sel", en: "a pinch of soot and salt" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: true,
    description: { fr: "Pour toute la durée, vous comprenez le sens littéral de toute langue parlée que vous entendez. Vous comprenez également tout écrit que vous voyez, à condition de toucher la surface sur laquelle il est rédigé. Il vous faut environ 1 minute pour lire une page de texte. Ce sort ne décrypte pas les symboles ni les messages secrets.", en: "For the duration, you understand the literal meaning of any language that you hear or see signed. You also understand any written language that you see, but you must be touching the surface on which the words are written. It takes about 1 minute to read one page of text. This spell doesn’t decode symbols or secret messages." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "compulsion",
    name: { fr: "Compulsion", en: "Compulsion" },
    level: 4,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  {
    id: "confusion",
    name: { fr: "Confusion", en: "Confusion" },
    level: 4,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "27 m", en: "90 feet" },
    components: { v: true, s: true, m: true, material: { fr: "trois coquilles de noix", en: "three nut shells" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Chaque créature prise dans une Sphère de 3 m de rayon centrée sur un point que vous choisissez à portée doit réussir un jet de sauvegarde de Sagesse, sous peine de ne pas pouvoir jouer de Réaction ni entreprendre d’action Bonus et de devoir jeter 1d10 au début de chacun de ses tours pour savoir comment elle se comporte à ce tour, selon la table ci-après.\n1d10 — Comportement du tour\n1 — La cible n’entreprend aucune action et consacre tout son déplacement à se déplacer. Lancez 1d4 pour la direction : 1, nord ; 2, est ; 3, sud ; 4, ouest.\n2–6 — La cible ne se déplace pas et n’entreprend aucune action.\n7–8 — La cible ne se déplace pas et entreprend l’action Attaque pour effectuer une attaque de corps à corps contre une créature aléatoire à portée d’allonge. Si aucune créature n’est à portée d’allonge, la cible n’entreprend aucune action.\n9–10 — La cible agit et se déplace à sa guise.\nLa cible affectée réitère le JS à la fin de chacun de ses tours et met un terme au sort sur elle-même en cas de réussite.", en: "Each creature in a 10-foot-radius Sphere centered on a point you choose within range must succeed on a Wisdom saving throw, or that target can’t take Bonus Actions or Reactions and must roll 1d10 at the start of each of its turns to determine its behavior for that turn, consulting the table below.\n1d10 — Behavior for the Turn\n1 — The target doesn’t take an action, and it uses all its movement to move. Roll 1d4 for the direction: 1, north; 2, east; 3, south; or 4, west.\n2–6 — The target doesn’t move or take actions.\n7–8 — The target doesn’t move, and it takes the Attack action to make one melee attack against a random creature within reach. If none are within reach, the target takes no action.\n9–10 — The target chooses its behavior.\nAt the end of each of its turns, an affected target repeats the save, ending the spell on itself on a success." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Le rayon de la Sphère augmente de 1,50 m par niveau d’emplacement au-delà du 4e .", en: "Using a Higher-Level Spell Slot. The Sphere’s radius increases by 5 feet for each spell slot level above 4." },
    classes: ["bard","druid","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "contact-avec-les-plans",
    name: { fr: "Contact avec les plans", en: "Contact Other Plane" },
    level: 5,
    school: "divination",
    castingTime: { fr: "1 minute ou rituel", en: "1 minute or Ritual" },
    range: { fr: "personnelle", en: "Self" },
  ...
  {
    id: "contact-glacial",
    name: { fr: "Contact glacial", en: "Chill Touch" },
    level: 0,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous canalisez l’étreinte d’outre-tombe et effectuez une attaque de sort au corps à corps contre une cible à portée d’allonge. Si l’attaque touche, la cible subit 1d10 dégâts nécrotiques et ne peut pas récupérer de points de vie jusqu’à la fin de votre tour suivant", en: "Channeling the chill of the grave, make a melee spell attack against a target within reach. On a hit, the target takes 1d10 Necrotic damage, and it can’t regain Hit Points until the end of your next turn." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Les dégâts augmentent de 1d10 lorsque vous atteignez les niveaux 5 (2d10), 11 (3d10) et 17 (4d10).", en: "Cantrip Upgrade. The damage increases by 1d10 when you reach levels 5 (2d10), 11 (3d10), and 17 (4d10)." },
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "contagion",
    name: { fr: "Contagion", en: "Contagion" },
    level: 5,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous libérez une magie virulente sur une créature que vous voyez à portée. La cible effectue un jet de sauvegarde de Constitution. En cas d’échec, elle subit 14d6 dégâts nécrotiques et son maximum de points de vie est réduit d’autant que les dégâts nécrotiques subis. En cas de réussite, elle subit uniquement la moitié de ces dégâts. Ce sort ne peut réduire son maximum de points de vie en dessous de 1.", en: "You unleash virulent magic on a creature you can see within range. The target makes a Constitution saving throw. On a failed save, it takes 14d6 Necrotic damage, and its Hit Point maximum is reduced by an amount equal to the Necrotic damage it took. On a successful save, it takes half as much damage only. This spell can’t reduce a target’s Hit Point maximum below 1." },
    atHigherLevels: null,
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  {
    id: "contresort",
    name: { fr: "Contresort", en: "Counterspell" },
    level: 3,
    school: "abjuration",
    castingTime: { fr: "Réaction, que vous jouez en voyant dans un rayon de 18 m une créature lancer un sort avec une composante verbale, somatique ou matérielle", en: "Reaction, which you take when you see a creature within 60 feet of yourself casting a spell with Verbal, Somatic, or Material components" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: false, s: true, m: false },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous tentez d’interrompre une créature en pleine incantation. La créature effectue un jet de sauvegarde de Constitution. En cas d’échec, son sort se dissipe sans effet et l’action, l’action Bonus ou la Réaction entreprise pour l’incantation est gaspillée. Si ce sort était lancé par un emplacement, celui-ci n’est pas dépensé.", en: "You attempt to interrupt a creature in the process of casting a spell. The creature makes a Constitution saving throw. On a failed save, the spell dissipates with no effect, and the action, Bonus Action, or Reaction used to cast it is wasted. If that spell was cast with a spell slot, the slot isn’t expended." },
    atHigherLevels: null,
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "coquille-antivie",
    name: { fr: "Coquille antivie", en: "Antilife Shell" },
    level: 5,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Une aura rayonne depuis vous pour toute la durée, sous forme d’une Émanation de 3 m. L’aura empêche les créatures autres que les Artificiels et les Mortsvivants de la franchir ou même d’y passer quelque partie de leur anatomie. Une créature affectée peut en revanche lancer des sorts ou effectuer des attaques à distance (ou avec des armes à allonge) à travers la barrière. Si votre déplacement oblige une créature affectée à traverser la barrière, le sort prend fin.", en: "An aura extends from you in a 10-foot Emanation for the duration. The aura prevents creatures other than Constructs and Undead from passing or reaching through it. An affected creature can cast spells or make attacks with Ranged or Reach weapons through the barrier. If you move so that an affected creature is forced to pass through the barrier, the spell ends." },
    atHigherLevels: null,
    classes: ["druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "corde-enchantee",
    name: { fr: "Corde enchantée", en: "Rope Trick" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "de la corde", en: "a segment of rope" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez une corde. Une extrémité de la corde se dresse dans les airs jusqu’à ce que toute la corde soit perpendiculaire au sol ou qu’elle atteigne un plafond. À son extrémité supérieure, un portail Invisible de 1,50 m sur 90 cm donne sur un espace extradimensionnel qui persiste jusqu’à la fin du sort. On peut accéder à cet espace en grimpant au sommet de la corde qu’on peut haler dans l’espace ou laisser choir de l’ouverture. L’espace peut accueillir un maximum de huit créatures de taille M ou inférieure. Les attaques, sorts et autres effets ne peuvent franchir l’entrée de l’espace extradimensionnel, dans un sens comme dans l’autre, mais ses occupants voient ce qui se passe à l’extérieur. Tout ce qui se trouve à l’intérieur de l’espace tombe quand le sort prend fin.", en: "You touch a rope. One end of it hovers upward until the rope hangs perpendicular to the ground or the rope reaches a ceiling. At the rope’s upper end, an Invisible 3-foot-by-5-foot portal opens to an extradimensional space that lasts until the spell ends. That space can be reached by climbing the rope, which can be pulled into or dropped out of it.\nThe space can hold up to eight Medium or smaller creatures. Attacks, spells, and other effects can’t pass into or out of the space, but creatures inside it can see through the portal. Anything inside the space drops out when the spell ends." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Couleurs dansantes", en: "Color Spray" },
    level: 1,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une pincée de sable coloré", en: "a pinch of colorful sand" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous projetez une gerbe éblouissante de lumière colorée. Chaque créature prise dans un Cône de 4,50 m émanant de vous doit réussir un jet de sauvegarde de Constitution sous peine de subir l’état Aveuglé jusqu’à la fin de votre tour suivant.", en: "You launch a dazzling array of flashing, colorful light. Each creature in a 15-foot Cone originating from you must succeed on a Constitution saving throw or have the Blinded condition until the end of your next turn." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "coup-au-but",
    name: { fr: "Coup au but", en: "True Strike" },
    level: 0,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: false, s: true, m: true, material: { fr: "une arme dont vous avez la maî- trise, d’une valeur minimale de 1 pc", en: "a weapon with which you have profi- ciency and that is worth 1+ CP" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Une fulgurance magique vous guide pour effectuer une attaque avec l’arme utilisée pour l’incantation. Les jets d’attaque et de dégâts correspondants se basent sur votre caractéristique d’incantation, au lieu de la Force ou la Dextérité. Si l’attaque inflige des dégâts, il peut s’agir de dégâts radiants ou des dégâts normaux de l’arme (à votre convenance).", en: "Guided by a flash of magical insight, you make one attack with the weapon used in the spell’s casting. The attack uses your spellcasting ability for the attack and damage rolls instead of using Strength or Dexterity. If the attack deals damage, it can be Radiant damage or the weapon’s normal damage type (your choice)." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Que vous infligiez des dégâts radiants ou les dégâts normaux de l’arme, l’attaque inflige des dégâts radiants supplémentaires lorsque vous atteignez les niveaux 5 (1d6), 11 (2d6) et 17 (3d6).", en: "Cantrip Upgrade. Whether you deal Radiant damage or the weapon’s normal damage type, the attack deals extra Radiant damage when you reach levels 5 (1d6), 11 (2d6), and 17 (3d6)." },
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "couteau-de-glace",
    name: { fr: "Couteau de glace", en: "Ice Knife" },
    level: 1,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: false, s: true, m: true, material: { fr: "une goutte d’eau ou un morceau de glace", en: "a drop of water or a piece of ice" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous créez un fragment de glace que vous lancez sur une créature à portée. Effectuez une attaque de sort à distance contre la cible. Si l’attaque touche, la cible subit 1d10 dégâts perforants. Que l’attaque touche ou rate, le fragment explose alors. La cible et toutes les créatures situées dans un rayon de 1,50 m d’elle doivent réussir un jet de sauvegarde de Dextérité, sous peine de subir 2d6 dégâts de froid", en: "You create a shard of ice and fling it at one creature within range. Make a ranged spell attack against the target. On a hit, the target takes 1d10 Piercing damage. Hit or miss, the shard then explodes. The target and each creature within 5 feet of it must succeed on a Dexterity saving throw or take 2d6 Cold damage." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts de froid augmentent de 1d6 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The Cold damage increases by 1d6 for each spell slot level above 1." },
    classes: ["druid","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous créez 22,5 kg de nourriture et 120 litres d’eau potable qui apparaissent au sol ou dans des récipients à portée, de quoi mettre à l’abri de la faim et de la soif. La nourriture est fade, mais nourrissante, avec l’aspect des aliments de votre choix, et l’eau est propre. La nourriture se gâte si elle n’est pas consommée dans les 24 heures.", en: "You create 45 pounds of food and 30 gallons of fresh water on the ground or in containers within range—both useful in fending off the hazards of malnutrition and dehydration. The food is bland but nourishing and looks like a food of your choice, and the water is clean. The food spoils after 24 hours if uneaten." },
    atHigherLevels: null,
    classes: ["cleric","paladin"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Création ou destruction d’eau", en: "Create or Destroy Water" },
    level: 1,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un mélange d’eau et de sable", en: "a mix of water and sand" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous accomplissez l’une des tâches suivantes : Création d’eau. Vous créez jusqu’à 40 litres d’eau propre dans un récipient ouvert à portée. Une autre option consiste à faire pleuvoir cette eau dans un Cube de 9 m à portée, ce qui éteint les flammes nues de la zone. Destruction d’eau. Vous détruisez jusqu’à 40 litres d’eau dans un récipient ouvert à portée. Au lieu de cela, vous pouvez chasser le brouillard dans un Cube de 9 m à portée.", en: "You do one of the following: Create Water. You create up to 10 gallons of clean water within range in an open container. Alternatively, the water falls as rain in a 30-foot Cube within range, extinguishing exposed flames there. Des t roy Water. You destroy up to 10 gallons of water in an open container within range. Alternatively, you destroy fog in a 30-foot Cube within range." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous créez ou détruisez 40 litres supplémentaires d’eau (ou l’arête du Cube augmente de 1,50 m) par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You create or destroy 10 additional gallons of water, or the size of the Cube increases by 5 feet, for each spell slot level above 1." },
    classes: ["cleric","druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "croissance-d-epines",
    name: { fr: "Croissance d’épines", en: "Spike Growth" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "45 m", en: "150 feet" },
    components: { v: true, s: true, m: true, material: { fr: "sept épines", en: "seven thorns" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: false,
    description: { fr: "Le sol dans une Sphère de 6 m de rayon centrée sur un point à portée laisse émerger des pointes et épines\ncoriaces. La zone devient un Terrain difficile pour toute la durée. Lorsqu’une créature pénètre dans la zone ou s’y déplace, elle subit 2d4 dégâts perforants par tranche de 1,50 m qu’elle y parcourt. La transformation du sol paraît naturelle. Toute créature qui ne voit pas la zone au moment de l’incantation doit entreprendre l’action Observation et réussir un test de Sagesse (Perception ou Survie) assorti de votre DD de sauvegarde des sorts pour reconnaître le danger avant de fouler ce sol.", en: "The ground in a 20-foot-radius Sphere centered on a point within range sprouts hard spikes and thorns. The area becomes Difficult Terrain for the duration. When a creature moves into or within the area, it takes 2d4 Piercing damage for every 5 feet it travels. The transformation of the ground is camouflaged to look natural. Any creature that can’t see the area when the spell is cast must take a Search action and succeed on a Wisdom (Perception or Survival) check against your spell save DC to recognize the terrain as hazardous before entering it." },
    atHigherLevels: null,
    classes: ["druid","ranger"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Croissance végétale", en: "Plant Growth" },
    level: 3,
    school: "transmutation",
    castingTime: { fr: "action (Embroussaillement) ou 8 heures (Fertilisation)", en: "Action (Overgrowth) or 8 hours (Enrichment)" },
    range: { fr: "45 m", en: "150 feet" },
    components: { v: true, s: true, m: false },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Ce sort gorge les plantes de vitalité. La durée d’incantation employée détermine l’effet du sort : Embroussaillement ou Fertilisation, ci-après. Embroussaillement. Choisissez un point à portée. Toutes les plantes normales dans une Sphère d’un rayon de 30 m centré sur ce point grossissent et grandissent. Une créature qui se déplace dans la zone doit dépenser le quadruple de déplacement pour toute distance parcourue. Vous pouvez désigner une ou plusieurs zones de n’importe quelle taille dans la zone d’effet du sort pour qu’elles ne soient pas affectées. Fertilisation. Toutes les plantes dans un rayon de 750 m d’un point à portée gagnent en fécondité pendant 365 jours. Ces plantes produisent le double des apports alimentaires normaux lors des récoltes. Elles ne peuvent tirer profit de croissance végétale qu’une fois par an.", en: "This spell channels vitality into plants. The casting time you use determines whether the spell has the Overgrowth or the Enrichment effect below. Overgrowth. Choose a point within range. All normal plants in a 100-foot-radius Sphere centered on that point become thick and overgrown. A creature moving through that area must spend 4 feet of movement for every 1 foot it moves. You can exclude one or more areas of any size within the spell’s area from being affected. Enrichment. All plants in a half-mile radius centered on a point within range become enriched for 365 days. The plants yield twice the normal amount of food when harvested. They can benefit from only one Plant Growth per yea r." },
    atHigherLevels: null,
    classes: ["bard","druid","ranger"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Crosse des druides", en: "Shillelagh" },
    level: 0,
    school: "transmutation",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "du gui", en: "mistletoe" } },
    duration: { fr: "1 minute", en: "1 minute" },
    concentration: false,
    ritual: false,
    description: { fr: "Le bois d’un gourdin ou d’un bâton de combat que vous tenez s’imprègne du pouvoir de la nature. Pour toute la durée, vous pouvez recourir à votre caractéristique d’incantation plutôt qu’à la Force pour les jets d’attaque et de dégâts de vos attaques de corps à corps effectuées avec cette arme. Le dé de dégâts de l’arme passe en outre à d8. Si l’attaque inflige des dégâts, il peut s’agir de dégâts de force ou des dégâts normaux de l’arme (à votre convenance). Le sort prend fin prématurément si vous le relancez ou si vous lâchez l’arme.", en: "A Club or Quarterstaff you are holding is imbued with nature’s power. For the duration, you can use your spellcasting ability instead of Strength for the attack and damage rolls of melee attacks using that weapon, and the weapon’s damage die becomes a d8. If the attack deals damage, it can be Force damage or the weapon’s normal damage type (your choice).\nThe spell ends early if you cast it again or if you let go of the weapon." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Le dé de dégâts change lorsque vous atteignez les niveaux 5 (d10), 11 (d12) et 17 (2d6).", en: "Cantrip Upgrade. The damage die changes when you reach levels 5 (d10), 11 (d12), and 17 (2d6)." },
    classes: ["druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "danse-irresistible",
    name: { fr: "Danse irrésistible", en: "Irresistible Dance" },
    level: 6,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Choisissez une créature que vous voyez à portée ; elle effectue un jet de sauvegarde de Sagesse. En cas de réussite, la cible entame une danse grotesque sur place en y consacrant tout son déplacement jusqu’à la fin de son tour suivant. En cas d’échec, la cible subit l’état Charmé pour toute la durée. Ainsi Charmée, la cible danse grotesquement en y consacrant tout son déplacement sans quitter son espace, et elle a le Désavantage aux jets de sauvegarde de Dextérité et aux jets d’attaque, tandis que les autres créatures ont l’Avantage aux jets d’attaque contre elle. À chacun de ses tours, la cible peut consacrer une action à tenter de retrouver ses esprits et réitérer le JS ; elle met fin au sort sur elle-même en cas de réussite.", en: "One creature that you can see within range must make a Wisdom saving throw. On a successful save, the target dances comically until the end of its next turn, during which it must spend all its movement to dance in place.\nOn a failed save, the target has the Charmed condition for the duration. While Charmed, the target dances comically, must use all its movement to dance in place, and has Disadvantage on Dexterity saving throws and attack rolls, and other creatures have Advantage on attack rolls against it. On each of its turns, the target can take an action to collect itself and repeat the save, ending the spell on itself on a success." },
    atHigherLevels: null,
    classes: ["bard","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Choisissez un objet que vous voyez à portée. Il peut s’agir d’une porte, d’une boîte, d’un coffre, de menottes, d’un cadenas ou autre objet muni d’un système de fermeture, magique ou non. Une cible verrouillée par une serrure ordinaire, barrée ou coincée est aussitôt déverrouillée, débloquée ou décoincée. Si l’objet présente plusieurs verrous, un seul d’entre eux est débloqué. Si la cible est fermée par verrou magique, ce sort est réprimé pendant 10 minutes, durant lesquelles vous pouvez ouvrir et fermer l’objet. À l’incantation du sort, un cognement sonore audible à 90 m émane de la cible.", en: "Choose an object that you can see within range. The object can be a door, a box, a chest, a set of manacles, a padlock, or another object that contains a mundane or magical means that prevents access.\nA target that is held shut by a mundane lock or that is stuck or barred becomes unlocked, unstuck, or unbarred. If the object has multiple locks, only one of them is unlocked.\nIf the target is held shut by Arcane Lock, that spell is suppressed for 10 minutes, during which time the target can be opened and closed.\nWhen you cast the spell, a loud knock, audible up to 300 feet away, emanates from the target." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "decharge-occulte",
    name: { fr: "Décharge occulte", en: "Eldritch Blast" },
    level: 0,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous projetez un rayon d’énergie crépitante. Effectuez une attaque de sort à distance contre une créature ou un objet à portée. Si l’attaque touche, la cible subit 1d10 dégâts de force.", en: "You hurl a beam of crackling energy. Make a ranged spell attack against one creature or object in range. On a hit, the target takes 1d10 Force damage." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Le sort produit deux rayons au niveau 5, trois au niveau 11 et quatre au niveau 17. Vous pouvez viser la même cible avec ces\nrayons ou les répartir entre plusieurs cibles. Effectuez un jet d’attaque séparé pour chaque rayon.", en: "Cantrip Upgrade. The spell creates two beams at level 5, three beams at level 11, and four beams at level 17. You can direct the beams at the same target or at different ones. Make a separate attack roll for each beam." },
    classes: ["warlock"],
    source: 'srd-5.2.1',
  },
  {
    id: "dedale",
    name: { fr: "Dédale", en: "Maze" },
    level: 8,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous bannissez une créature que vous voyez à portée dans un demi-plan labyrinthique. La cible y reste pour toute la durée, à moins qu’elle n’en trouve la sortie. La cible peut entreprendre l’action Étude pour tenter de s’évader. Ce faisant, elle effectue un test d’Intelligence (Investigation) DD 20. En cas de réussite, elle s’évade et le sort prend fin. Lorsque le sort prend fin, la cible réapparaît dans l’espace qu’elle avait quitté ou, si celui-ci n’est plus libre, dans l’espace inoccupé le plus proche.", en: "You banish a creature that you can see within range into a labyrinthine demiplane. The target remains there for the duration or until it escapes the maze.\nThe target can take a Study action to try to escape. When it does so, it makes a DC 20 Intelligence (Investigation) check. If it succeeds, it escapes, and the spell ends.\nWhen the spell ends, the target reappears in the space it left or, if that space is occupied, in the nearest unoccupied space." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "deguisement",
    name: { fr: "Déguisement", en: "Disguise Self" },
    level: 1,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    name: { fr: "Délivrance des malédictions", en: "Remove Curse" },
    level: 3,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "À votre contact, toutes les malédictions qui affectent une créature ou un objet prennent fin. Si la cible est un objet magique maudit, la malédiction reste en place, mais le sort rompt l’Harmonisation du propriétaire avec l’objet, si bien que celui-ci peut s’en défaire ou s’en déba r ra sser.", en: "At your touch, all curses affecting one creature or object end. If the object is a cursed magic item, its curse remains, but the spell breaks its owner’s Attunement to the object so it can be removed or discarded." },
    atHigherLevels: null,
    classes: ["cleric","paladin","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "demi-plan",
    name: { fr: "Demi-plan", en: "Demiplane" },
    level: 8,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    name: { fr: "Détection des pièges", en: "Find Traps" },
    level: 2,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
  ...
  },
  {
    ...
    name: { fr: "Détection du mal et du bien", en: "Detect Evil and Good" },
    level: 1,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    name: { fr: "Détection du poison et des maladies", en: "Detect Poison and Disease" },
    level: 1,
    school: "divination",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une feuille d’if", en: "a yew leaf" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: true,
    description: { fr: "Pour toute la durée, vous percevez la position de tous les poisons, créatures venimeuses et vénéneuses, et maladies magiques dans un rayon de 9 m. Vous percevez dans chaque cas de quel genre de poison, créature ou maladie il s’agit. Le sort est bloqué par 30 cm de pierre, de terre ou de bois, par 2,5 cm de métal (une simple feuille dans le cas du plomb).", en: "For the duration, you sense the location of poisons, poisonous or venomous creatures, and magical contagions within 30 feet of yourself. You sense the kind of poison, creature, or contagion in each case.\nThe spell is blocked by 1 foot of stone, dirt, or wood; 1 inch of metal; or a thin sheet of lead." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Discours captivant", en: "Enthrall" },
    level: 2,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    name: { fr: "Dissimulation suprême", en: "Sequester" },
    level: 7,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "poudre de gemme d’une valeur minimale de 5 000 po, que le sort détruit", en: "gem dust worth 5,000+ GP, which the spell consumes" } },
    duration: { fr: "jusqu’à dissipation", en: "Until dispelled" },
    concentration: false,
    ritual: false,
    description: { fr: "D’un contact, vous isolez magiquement un objet ou une créature consentante. Pour toute la durée, la cible a l’état Invisible et les sorts de Divination ne peuvent pas la cibler, aucune magie ne peut la détecter ni l’observer à distance. Si la cible est une créature, elle sombre dans un état d’animation suspendue ; elle subit l’état Inconscient, ne vieillit pas et se passe de nourriture, d’eau et d’air. Vous pouvez fixer une condition qui mettra un terme prématuré au sort. Vous êtes libre de choisir n’importe quelle condition, mais elle doit intervenir ou être visible dans un rayon de 1,5 km de la cible. Ce peut être « au bout de 1 000 ans » ou « lorsque la tarasque s’éveillera », par exemple. Le sort prend également fin si la cible subit des dégâts.", en: "With a touch, you magically sequester an object or a willing creature. For the duration, the target has the Invisible condition and can’t be targeted by Divination spells, detected by magic, or viewed remotely with magic.\nIf the target is a creature, it enters a state of suspended animation; it has the Unconscious condition, doesn’t age, and doesn’t need food, water, or air.\nYou can set a condition for the spell to end early. The condition can be anything you choose, but it must occur or be visible within 1 mile of the target. Examples include “after 1,000 years” or “when the tarrasque awakens.” This spell also ends if the target takes any damage." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Dissipation de la magie", en: "Dispel Magic" },
    level: 3,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
  ...
  {
    id: "divination",
    name: { fr: "Divination", en: "Divination" },
    level: 4,
    school: "divination",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "encens d’une valeur minimale de 25 po, que le sort détruit", en: "incense worth 25+ GP, which the spell consumes" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: true,
    description: { fr: "Ce sort vous met en contact avec un dieu ou ses serviteurs. Vous posez une question au sujet d’un objectif précis, d’un événement ou d’une activité censés intervenir dans les 7 jours. Le MJ vous répond par la vérité, qui peut s’énoncer par une courte phrase ou un vers abscons. Le sort ne tient pas compte des conjonctures qui pourraient peser dans la balance, comme l’incantation de nouveaux sorts. Si vous lancez le sort plus d’une fois avant de terminer votre prochain Repos long, vous courez dès la deuxième incantation 25 % de risques cumulatifs qu’il ne vous livre aucune réponse.", en: "This spell puts you in contact with a god or a god’s servants. You ask one question about a specific goal, event, or activity to occur within 7 days. The GM offers a truthful reply, which might be a short phrase or cryptic rhyme. The spell doesn’t account for circumstances that might change the answer, such as the casting of other spells. If you cast the spell more than once before finishing a Long Rest, there is a cumulative 25 percent chance for each casting after the first that you get no a ns wer." },
    atHigherLevels: null,
    classes: ["cleric","druid","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "doigt-de-mort",
    name: { fr: "Doigt de mort", en: "Finger of Death" },
    level: 7,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous libérez des énergies négatives vers une créature que vous voyez à portée. La cible effectue un jet de sauvegarde de Constitution et subit 7d8 + 30 dégâts nécrotiques en cas d’échec, la moitié en cas de réussite. Un Humanoïde tué par ce sort se relève au début de votre tour suivant comme zombi (cf. « Monstres ») obéissant à vos instructions verbales.", en: "You unleash negative energy toward a creature you can see within range. The target makes a Constitution saving throw, taking 7d8 + 30 Necrotic damage on a failed save or half as much damage on a successful one.\nA Humanoid killed by this spell rises at the start of your next turn as a Zombie (see “Monsters”) that follows your verbal orders." },
    atHigherLevels: null,
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "domination-de-bete",
    name: { fr: "Domination de bête", en: "Dominate Beast" },
    level: 4,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Une créature que vous voyez à portée doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Charmé pour toute la durée. La cible a l’Avantage au JS si vous ou vos alliés êtes en train de l’affronter. Chaque fois que la cible subit des dégâts, elle réitère le JS et met un terme au sort sur elle-même en cas de réussite. Un lien télépathique persiste entre vous et la cible Charmée tant que vous êtes tous deux sur un même plan d’existence. À votre tour, vous pouvez profiter de ce lien pour donner des ordres à la cible (pas d’action requise), tels que « Attaque cette créature », « File là-bas » ou « Attrape cet objet ». La cible fait de son mieux pour vous obéir à son tour. Si la créature accomplit sa tâche et ne reçoit pas d’autre instruction de votre part, elle agit et se déplace à sa guise, en cherchant avant tout à se protéger. Vous pouvez aussi lui faire jouer une Réaction, au prix toutefois de votre propre Réaction.", en: "One creature you can see within range must succeed on a Wisdom saving throw or have the Charmed condition for the duration. The target has Advantage on the save if you or your allies are fighting it. Whenever the target takes damage, it repeats the save, ending the spell on itself on a success.\nYou have a telepathic link with the Charmed target while the two of you are on the same plane of existence. On your turn, you can use this link to issue commands to the target (no action required), such as “Attack that creature,” “Move over there,” or “Fetch that object.” The target does its best to obey on its turn. If it completes an order and doesn’t receive further direction from you, it acts and moves as it likes, focusing on protecting itself.\nYou can command the target to take a Reaction but must take your own Reaction to do so." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vot re Concentration peut persister plus longtemps avec un emplacement du 9e niveau (jusqu’à 8 heures).", en: "Using a Higher-Level Spell Slot. Your Concentration can last longer with a level 9 spell slot (up to 8 hours)." },
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "domination-de-personne",
    name: { fr: "Domination de personne", en: "Dominate Person" },
    level: 5,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Un Humanoïde que vous voyez à portée doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Charmé pour toute la durée. La cible a l’Avantage au JS si vous ou vos alliés êtes en train de l’affronter. Chaque fois que la cible subit des dégâts, elle réitère le JS et met un terme au sort sur elle-même en cas de réussite. Un lien télépathique persiste entre vous et la cible Charmée tant que vous êtes tous deux sur un même plan d’existence. À votre tour, vous pouvez profiter de ce lien pour donner des ordres à la cible (pas d’action requise), tels que « Attaque cette créature », « File là-bas » ou « Attrape cet objet ». La cible fait de son mieux pour vous obéir à son tour. Si la créature accomplit sa tâche et ne reçoit pas d’autre instruction de votre part, elle agit et se déplace à sa guise, en cherchant avant tout à se protéger. Vous pouvez aussi lui faire jouer une Réaction, au prix toutefois de votre propre Réaction.", en: "One Humanoid you can see within range must succeed on a Wisdom saving throw or have the Charmed condition for the duration. The target has Advantage on the save if you or your allies are fighting it. Whenever the target takes damage, it repeats the save, ending the spell on itself on a success.\nYou have a telepathic link with the Charmed target while the two of you are on the same plane of existence. On your turn, you can use this link to issue commands to the target (no action required), such as “Attack that creature,” “Move over there,” or “Fetch that object.” The target does its best to obey on its turn. If it completes an order and doesn’t receive further direction from you, it acts and moves as it likes, focusing on protecting itself.\nYou can command the target to take a Reaction but must take your own Reaction to do so." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Votre Concentration peut persister plus longtemps avec un emplacement du 6e niveau (jusqu’à 10 minutes), du 7e (jusqu’à 1 heure), ou du 8e et supérieur (jusqu’à 8 heures).", en: "Using a Higher-Level Spell Slot. Your Concentration can last longer with a spell slot of level 6 (up to 10 minutes), 7 (up to 1 hour), or 8+ (up to 8 hours)." },
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "don-des-langues",
    name: { fr: "Don des langues", en: "Tongues" },
    level: 3,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: false, m: true, material: { fr: "une ziggourat miniature", en: "a miniature ziggurat" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Ce sort octroie à la créature que vous touchez la faculté de comprendre toute langue parlée qu’elle entend et tout langage des signes qu’elle voit. De plus, lorsque la cible communique par signes ou par la voix, toute créature qui connaît au moins une langue comprend ce que la cible exprime à condition d’entendre ce qu’elle dit ou de voir sa gestuelle.", en: "This spell grants the creature you touch the ability to understand any spoken or signed language that it hears or sees. Moreover, when the target communicates by speaking or signing, any creature that\nknows at least one language can understand it if that creature can hear the speech or see the signing." },
    atHigherLevels: null,
  ...
  {
    id: "double-illusoire",
    name: { fr: "Double illusoire", en: "Mislead" },
    level: 5,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  {
    id: "doux-repos",
    name: { fr: "Doux repos", en: "Gentle Repose" },
    level: 2,
    school: "necromancy",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "2 pièces de cuivre, que le sort détruit", en: "2 Copper Pieces, which the spell consumes" } },
    duration: { fr: "10 jours", en: "10 days" },
    concentration: false,
    ritual: true,
    description: { fr: "Vous touchez physiquement un cadavre ou autre dépouille. Pour toute la durée, la cible est protégée contre la putréfaction et rien ne peut en faire un Mort-vivant. Ce sort prolonge également le délai au-delà duquel la cible ne pourra plus être ramenée d’entre les morts, les jours passés sous l’influence de ce sort n’étant pas décomptés dans le cadre de sorts tels que rappel à la vie.", en: "You touch a corpse or other remains. For the duration, the target is protected from decay and can’t become Undead.\nThe spell also effectively extends the time limit on raising the target from the dead, since days spent under the influence of this spell don’t count against the time limit of spells such as Raise Dead." },
    atHigherLevels: null,
  ...
  {
    id: "druidisme",
    name: { fr: "Druidisme", en: "Druidcraft" },
    level: 0,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  {
    id: "eclair",
    name: { fr: "Éclair", en: "Lightning Bolt" },
    level: 3,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une touffe de fourrure et une tige de cristal", en: "a bit of fur and a crystal rod" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Un éclair foudroyant jaillit de vous sous la forme d’une Ligne de 30 m de long et 1,50 m de large, dans la direction de votre choix. Chaque créature prise dans la Ligne effectue un jet de sauvegarde de Dextérité et subit 8d6 dégâts de foudre en cas d’échec, la moitié en cas de réussite.", en: "A stroke of lightning forming a 100-foot-long, 5-foot-wide Line blasts out from you in a direction you choose. Each creature in the Line makes a Dexterity saving throw, taking 8d6 Lightning damage on a failed save or half as much damage on a successful one." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d6 par niveau d’emplacement au-delà du 3e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d6 for each spell slot level above 3." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "elementalisme",
    name: { fr: "Élémentalisme", en: "Elementalism" },
    level: 0,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  },
  {
    ...
    name: { fr: "Embruns prismatiques", en: "Prismatic Spray" },
    level: 7,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  {
    id: "enchevetrement",
    name: { fr: "Enchevêtrement", en: "Entangle" },
    level: 1,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "27 m", en: "90 feet" },
  ...
  },
  {
    ...
    name: { fr: "Ennemi subconscient", en: "Weird" },
    level: 9,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous tentez de produire une terreur illusoire dans l’esprit d’autrui. Chaque créature que vous choisissez dans une Sphère de 9 m de rayon centrée sur un point à portée effectue un jet de sauvegarde de Sagesse. En cas d’échec, elle subit 10d10 dégâts psychiques, ainsi que l’état Effrayé pour toute la durée. En cas de réussite, elle subit uniquement la moitié de ces dégâts. Une cible Effrayée effectue un JS Sagesse à la fin de chacun de ses tours. En cas d’échec, elle subit 5d10 dégâts psychiques. En cas de réussite, le sort prend fin pour elle.", en: "You try to create illusory terrors in others’ minds. Each creature of your choice in a 30-foot-radius Sphere centered on a point within range makes a Wisdom saving throw. On a failed save, a target takes 10d10 Psychic damage and has the Frightened condition for the duration. On a successful save, a target takes half as much damage only.\nA Frightened target makes a Wisdom saving throw at the end of each of its turns. On a failed save, it takes 5d10 Psychic damage. On a successful save, the spell ends on that target." },
    atHigherLevels: null,
    classes: ["warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "entrave-planaire",
    name: { fr: "Entrave planaire", en: "Planar Binding" },
    level: 5,
    school: "abjuration",
    castingTime: { fr: "1 heure", en: "1 hour" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un joyau d’une valeur minimale de 1 000 po, que le sort détruit", en: "a jewel worth 1,000+ GP, which the spell consumes" } },
    duration: { fr: "24 heures", en: "24 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous tentez de soumettre un Céleste, un Élémentaire, une Fée ou un Fiélon à votre service. La créature doit être à portée pendant toute l’incantation. (Le plus souvent, on commence par convoquer la créature au centre d’un cercle magique inversé pour l’y séquestrer pendant l’incantation du présent sort.) À la fin de l’incantation, la cible doit réussir un jet de sauvegarde de Charisme sous peine d’être liée à votre service pour toute la durée. Si la créature a été convoquée ou créée par un autre sort, la durée de celui-ci augmente pour correspondre à la durée de cette entrave planaire. Une créature ainsi liée à votre service obéit à vos instructions de son mieux. Vous pouvez lui ordonner de vous accompagner à l’aventure, de garder un site ou de livrer un message. Si la créature est Hostile, elle cherche à détourner vos ordres à ses propres fins. Si la créature mène à bien toutes vos instructions avant la fin du sort, elle se transporte auprès de vous pour faire son rapport si vous êtes sur le même plan d’existence. Si vous vous trouvez sur un plan différent, elle repart vers le lieu où vous l’avez assujettie et y reste jusqu’à la fin du sort.", en: "You attempt to bind a Celestial, an Elemental, a Fey, or a Fiend to your service. The creature must be within range for the entire casting of the spell. (Typically, the creature is first summoned into the center of the inverted version of the Magic Circle spell to trap it while this spell is cast.) At the completion of the casting, the target must succeed on a Charisma saving throw or be bound to serve you for the duration. If the creature was summoned or created by another spell, that spell’s duration is extended to match the duration of this spell.\nA bound creature must follow your commands to the best of its ability. You might command the creature to accompany you on an adventure, to guard a location, or to deliver a message. If the creature is Hostile, it strives to twist your commands to achieve its own objectives. If the creature carries out your commands completely before the spell ends, it travels to you to report this fact if you are on the same plane of existence. If you are on a different plane, it returns to the place where you bound it and remains there until the spell ends." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. La durée augmente avec un emplacement du 6e niveau (10 jours), du 7e (30 jours), du 8e (180 jours) et du 9e (366 jours).", en: "Using a Higher-Level Spell Slot. The duration increases with a spell slot of level 6 (10 days), 7 (30 days), 8 (180 days), and 9 (366 days)." },
    classes: ["bard","cleric","druid","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "epee-arcanique",
    name: { fr: "Épée arcanique", en: "Arcane Sword" },
    level: 7,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "27 m", en: "90 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une épée miniature d’une valeur minimale de 250 po", en: "a miniature sword worth 250+ GP" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous créez une épée spectrale qui flotte dans les airs à portée. Elle persiste pour toute la durée. À l’apparition de l’épée, vous effectuez une attaque de sort au corps à corps contre une cible dans un rayon de 1,50 m de l’épée. Si l’attaque touche, la cible subit des dégâts de force égaux à 4d12 + votre modificateur de caractéristique d’incantation. À chacun de vos tours suivants, vous pouvez par une action Bonus déplacer l’épée d’un maximum de 9 m vers un point que vous voyez et réitérer l’attaque, contre la même cible ou une autre.", en: "You create a spectral sword that hovers within range. It lasts for the duration.\nWhen the sword appears, you make a melee spell attack against a target within 5 feet of the sword. On a hit, the target takes Force damage equal to 4d12 plus your spellcasting ability modifier.\nOn your later turns, you can take a Bonus Action to move the sword up to 30 feet to a spot you can see and repeat the attack against the same target or a different one." },
    atHigherLevels: null,
    classes: ["bard","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "epine-mentale",
    name: { fr: "Épine mentale", en: "Mind Spike" },
    level: 2,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Jusqu’à la fin du sort, une créature consentante que vous touchez physiquement bénéficie de l’Immunité contre les dégâts psychiques et l’état Charmé. La cible n’est pas davantage affectée par tout ce qui permet de percevoir les émotions ou l’alignement, de lire les pensées ou de détecter magiquement sa position, et aucun sort (pas même souhait) ne peut affecter l’esprit de la cible, l’observer à distance ou se renseigner sur son compte.", en: "Until the spell ends, one willing creature you touch has Immunity to Psychic damage and the Charmed condition. The target is also unaffected by anything that would sense its emotions or alignment, read its thoughts, or magically detect its location, and no spell—not even Wish—can gather information about the target, observe it remotely, or control its mind." },
    atHigherLevels: null,
    classes: ["bard","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "esprits-gardiens",
    name: { fr: "Esprits gardiens", en: "Spirit Guardians" },
    level: 3,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  {
    id: "fabrication",
    name: { fr: "Fabrication", en: "Fabricate" },
    level: 4,
    school: "transmutation",
    castingTime: { fr: "10 minutes", en: "10 minutes" },
    range: { fr: "36 m", en: "120 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous convertissez des matières premières en produits finis. Vous pouvez ainsi fabriquer un pont de bois à partir d’un massif d’arbres, une corde à partir d’un tas de chanvre et des vêtements avec de la laine ou du lin en vrac. Choisissez des matières premières que vous voyez à portée. Vous pouvez fabriquer un objet de taille G ou inférieure (qui loge dans un Cube de 3 m ou huit Cubes contigus de 1,50 m), à condition de disposer de suffisamment de matières premières. Si vous optez pour du métal, de la pierre ou toute autre substance minérale, l’objet fabriqué ne peut toutefois pas dépasser une taille M (qui loge dans un Cube de 1,50 m). La facture des objets ainsi confectionnés est à la mesure de la qualité des matières premières. Vous ne pouvez pas créer d’objet magique ni de créature avec ce sort. De même, vous ne pouvez pas créer d’objets dont la confection demande un savoir-faire exceptionnel, comme des armes ou des armures, sauf si vous disposez de la maîtrise des outils d’artisan correspondants.", en: "You convert raw materials into products of the same material. For example, you can fabricate a wooden bridge from a clump of trees, a rope from a patch of hemp, or clothes from flax or wool.\nChoose raw materials that you can see within range. You can fabricate a Large or smaller object (contained within a 10-foot Cube or eight connected 5-foot Cubes) given a sufficient quantity of material. If you’re working with metal, stone, or another mineral substance, however, the fabricated object can be no larger than Medium (contained within a 5-foot Cube). The quality of any fabricated objects is based on the quality of the raw materials.\nCreatures and magic items can’t be created by this spell. You also can’t use it to create items that require a high degree of skill—such as weapons and armor—unless you have proficiency with the type of Artisan’s Tools used to craft such objects." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Façonnage de la pierre", en: "Stone Shape" },
    level: 4,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "de la terre glaise", en: "soft clay" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement un objet de pierre de taille M ou inférieure ou une section de pierre dont aucune dimension n’excède 1,50 m, pour les modeler à votre guise. Vous pouvez ainsi façonner un gros rocher en arme, en statue ou en caisson, ou pratiquer un passage dans une paroi dont l’épaisseur ne dépasse pas 1,50 m. Vous pourriez aussi modeler une porte de pierre ou en refaçonner l’encadrement pour la condamner. L’objet confectionné peut être doté d’un maximum de deux charnières et d’un loquet, mais les éléments mécaniques plus sophistiqués sont proscrits.", en: "You touch a stone object of Medium size or smaller or a section of stone no more than 5 feet in any dimension and form it into any shape you like. For example, you could shape a large rock into a weapon, statue, or coffer, or you could make a small passage through a wall that is 5 feet thick. You could also shape a stone door or its frame to seal the door shut. The object you create can have up to two hinges and a latch, but finer mechanical detail isn’t possible." },
    atHigherLevels: null,
    classes: ["cleric","druid","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "faveur-divine",
    name: { fr: "Faveur divine", en: "Divine Favor" },
    level: 1,
    school: "transmutation",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Jusqu’à la fin du sort, vos attaques avec une arme infligent 1d4 dégâts radiants supplémentaires quand elles touchent.", en: "Until the spell ends, your attacks with weapons deal an extra 1d4 Radiant damage on a hit." },
    atHigherLevels: null,
    classes: ["paladin"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "feuille-morte",
    name: { fr: "Feuille morte", en: "Feather Fall" },
    level: 1,
    school: "transmutation",
    castingTime: { fr: "Réaction, que vous jouez quand vous ou une créature dans un rayon de 18 m chutez", en: "Reaction, which you take when you or a creature you can see within 60 feet of you falls" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: false, m: true, material: { fr: "une petite plume ou un peu de duvet", en: "a small feather or piece of down" } },
    duration: { fr: "1 minute", en: "1 minute" },
    concentration: false,
    ritual: false,
    description: { fr: "Choisissez jusqu’à cinq créatures qui chutent à portée. La vitesse de chute de chacune passe à 18 m par round jusqu’à la fin du sort. Si la créature atterrit avant la fin du sort, elle ne subit aucun dégât de chute et le sort prend fin en ce qui la concerne.", en: "Choose up to five falling creatures within range. A falling creature’s rate of descent slows to 60 feet per round until the spell ends. If a creature lands before the spell ends, the creature takes no damage from the fall, and the spell ends for that creature." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "flamme-eternelle",
    name: { fr: "Flamme éternelle", en: "Continual Flame" },
    level: 2,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "poudre de rubis d’une valeur minimale de 50 po, que le sort détruit", en: "ruby dust worth 50+ GP, which the spell consumes" } },
    duration: { fr: "jusqu’à dissipation", en: "Until dispelled" },
    concentration: false,
    ritual: false,
    description: { fr: "Une flamme jaillit d’un objet que vous touchez physiquement. L’effet produit une Lumière vive sur un rayon de 6 m et une Lumière faible sur 6 m de plus. La flamme paraît ordinaire, mais elle ne produit aucune chaleur et s’alimente d’elle-même. On peut recouvrir ou cacher la flamme, mais ni l’étouffer ni l’éteindre.", en: "A flame springs from an object that you touch. The effect casts Bright Light in a 20-foot radius and Dim Light for an additional 20 feet. It looks like a regular flame, but it creates no heat and consumes no fuel. The flame can be covered or hidden but not smothered or quenched." },
    atHigherLevels: null,
    classes: ["cleric","druid","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "flamme-sacree",
    name: { fr: "Flamme sacrée", en: "Sacred Flame" },
    level: 0,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une radiance embrasée s’abat sur une créature que vous voyez à portée. La cible doit réussir un jet de sauvegarde de Dextérité sous peine de subir 1d8 dégâts radiants. Les Abris partiels et supérieurs ne confèrent aucun bénéfice dans le cadre de ce jet de sauvegarde.", en: "Flame-like radiance descends on a creature that you can see within range. The target must succeed on a Dexterity saving throw or take 1d8 Radiant damage. The target gains no benefit from Half Cover or Three-Quarters Cover for this save." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Les dégâts augmentent de 1d8 lorsque vous atteignez les niveaux 5 (2d8), 11 (3d8) et 17 (4d8).", en: "Cantrip Upgrade. The damage increases by 1d8 when you reach levels 5 (2d8), 11 (3d8), and 17 (4d8)." },
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  {
    id: "flammes",
    name: { fr: "Flammes", en: "Produce Flame" },
    level: 0,
    school: "conjuration",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  {
    id: "fleau-d-insectes",
    name: { fr: "Fléau d’insectes", en: "Insect Plague" },
    level: 5,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "90 m", en: "300 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un criquet", en: "a locust" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: false,
    description: { fr: "Des nuées grouillantes de criquets emplissent une Sphère de 6 m de rayon centrée sur un point que vous choisissez à portée. La Sphère persiste pour toute la durée, et sa zone est à Visibilité réduite et constitue un Terrain difficile. Chaque créature prise dans la nuée à son apparition effectue un jet de sauvegarde de Constitution, et subit 4d10 dégâts perforants en cas d’échec, la moitié en cas de réussite. Une créature effectue aussi ce JS lorsqu’elle pénètre dans la zone du sort pour la première fois d’un tour ou qu’elle y termine son tour. Une même créature n’effectue en aucun cas ce JS plus d’une fois par tour.", en: "Swarming locusts fill a 20-foot-radius Sphere centered on a point you choose within range. The Sphere remains for the duration, and its area is Lightly Obscured and Difficult Terrain.\nWhen the swarm appears, each creature in it makes a Constitution saving throw, taking 4d10 Piercing damage on a failed save or half as much damage on a successful one. A creature also makes this save when it enters the spell’s area for the first time on a turn or ends its turn there. A creature makes this save only once per turn." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d10 par niveau d’emplacement au-delà du 5e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d10 for each spell slot level above 5." },
    classes: ["cleric","druid","sorcerer"],
    source: 'srd-5.2.1',
  },
  {
    id: "fleche-acide",
    name: { fr: "Flèche acide", en: "Acid Arrow" },
    level: 2,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "27 m", en: "90 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une feuille de rhubarbe en   poudre", en: "powdered rhubarb leaf" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Une flèche d’un vert chatoyant fuse vers une cible à portée avant de produire une gerbe d’acide. Effectuez une attaque de sort à distance contre la cible. Si l’attaque touche, la cible subit aussitôt 4d4 dégâts d’acide, puis 2d4 dégâts d’acide à la fin de son tour suivant. Si l’attaque rate, la flèche asperge la cible d’acide en lui infligeant uniquement la moitié des dégâts initiaux.", en: "A shimmering green arrow streaks toward a target within range and bursts in a spray of acid. Make a ranged spell attack against the target. On a hit, the target takes 4d4 Acid damage and 2d4 Acid damage at the end of its next turn. On a miss, the arrow splashes the target with acid for half as much of the initial damage only." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts (initiaux et consécutifs) augmentent de 1d4 par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The damage (both initial and later) increases by 1d4 for each spell slot level above 2." },
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "fletrissement",
    name: { fr: "Flétrissement", en: "Blight" },
    level: 4,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une créature que vous voyez à portée effectue un jet de sauvegarde de Constitution et subit 8d8 dégâts nécrotiques en cas d’échec, la moitié en cas de réussite. Une Plante rate automatiquement ce JS. Au lieu de cela, vous pouvez cibler une plante non magique qui n’est pas une créature, comme un arbre ou un arbuste. Elle n’effectue pas de JS, mais se flétrit et meurt.", en: "A creature that you can see within range makes a Constitution saving throw, taking 8d8 Necrotic damage on a failed save or half as much damage on a successful one. A Plant creature automatically fails the save.\nAlternatively, target a nonmagical plant that isn’t a creature, such as a tree or shrub. It doesn’t make a save; it simply withers and dies." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 4e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for each spell slot level above 4." },
    classes: ["druid","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "flou",
    name: { fr: "Flou", en: "Blur" },
    level: 2,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Votre corps devient flou. Pour toute la durée, les créatures ont le Désavantage aux jets d’attaque contre vous. Un assaillant qui vous perçoit par la Vision aveugle ou la Vision lucide est immunisé contre cet effet.", en: "Your body becomes blurred. For the duration, any creature has Disadvantage on attack rolls against you. An attacker is immune to this effect if it perceives you with Blindsight or Truesight." },
    atHigherLevels: null,
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "foulee-brumeuse",
    name: { fr: "Foulée brumeuse", en: "Misty Step" },
    level: 2,
    school: "conjuration",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une brume argentée vous enveloppe brièvement et vous vous téléportez d’un maximum de 9 m vers un espace inoccupé que vous voyez.", en: "Briefly surrounded by silvery mist, you teleport up to 30 feet to an unoccupied space you can see." },
    atHigherLevels: null,
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "fracassement",
    name: { fr: "Fracassement", en: "Shatter" },
    level: 2,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un fragment de mica", en: "a chip of mica" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Un vacarme éclate en un point que vous choisissez à portée. Chaque créature prise dans une Sphère de 3 m de rayon centrée sur ce point effectue un jet de sauvegarde de Constitution et subit 3d8 dégâts de tonnerre en cas d’échec, la moitié en cas de réussite. Un Artificiel a le Désavantage à ce JS. Un objet non magique qui n’est porté par personne subit lui aussi les dégâts s’il est dans la zone d’effet du sort.", en: "A loud noise erupts from a point of your choice within range. Each creature in a 10-foot-radius Sphere centered there makes a Constitution saving throw, taking 3d8 Thunder damage on a failed save or half as much damage on a successful one. A Construct has Disadvantage on the save.\nA nonmagical object that isn’t being worn or carried also takes the damage if it’s in the spell’s area." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for each spell slot level above 2." },
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "frappe-piegeuse",
    name: { fr: "Frappe piégeuse", en: "Ensnaring Strike" },
    level: 1,
    school: "conjuration",
    castingTime: { fr: "action Bonus, que vous entre- prenez aussitôt après avoir touché une créature avec une arme", en: "Bonus Action, which you take immedi- ately after hitting a creature with a weapon" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: false, m: false },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Alors que vous touchez la cible, des plantes grimpantes se matérialisent sur elle et elle effectue un jet de sauvegarde de Force. Si la créature est de taille G ou supérieure, elle a l’Avantage au jet. En cas d’échec, elle subit l’état Entravé jusqu’à la fin du sort. En cas de réussite, les plantes disparaissent en se flétrissant et le sort prend fin. Tant qu’elle est Entravée, la cible subit 1d6 dégâts perforants au début de chacun de ses tours. La cible ou une créature à portée d’allonge de celle-ci peut entreprendre une action pour effectuer un test de Force (Athlétisme) contre votre DD de sauvegarde des sorts. En cas de réussite, le sort prend fin.", en: "As you hit the target, grasping vines appear on it, and it makes a Strength saving throw. A Large or larger creature has Advantage on this save. On a failed save, the target has the Restrained condition until the spell ends. On a successful save, the vines shrivel away, and the spell ends.\nWhile Restrained, the target takes 1d6 Piercing damage at the start of each of its turns. The target or a creature within reach of it can take an action to make a Strength (Athletics) check against your spell save DC. On a success, the spell ends." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d6 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d6 for each spell slot level above 1." },
    classes: ["ranger"],
    source: 'srd-5.2.1',
  },
  {
    id: "fusion-dans-la-pierre",
    name: { fr: "Fusion dans la pierre", en: "Meld into Stone" },
    level: 3,
    school: "transmutation",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "contact", en: "Touch" },
  ...
  },
  {
    ...
    name: { fr: "Gardien de la foi", en: "Guardian of Faith" },
    level: 4,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  {
    id: "grande-foulee",
    name: { fr: "Grande foulée", en: "Longstrider" },
    level: 1,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une pincée de terre", en: "a pinch of dirt" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez une créature. La Vitesse de la cible augmente de 3 m jusqu’à la fin du sort.", en: "You touch a creature. The target’s Speed increases by 10 feet until the spell ends." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 1." },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Choisissez une créature que vous voyez à portée. Une vague d’énergie positive baigne la créature, qui récupère 70 points de vie. Ce sort met également fin aux éventuels états Assourdi, Aveuglé et Empoisonné de la cible.", en: "Choose a creature that you can see within range. Positive energy washes through the target, restoring 70 Hit Points. This spell also ends the Blinded, Deafened, and Poisoned conditions on the target." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les soins augmentent de 10 par niveau d’emplacement au-delà du 6e .", en: "Using a Higher-Level Spell Slot. The healing increases by 10 for each spell slot level above 6." },
    classes: ["cleric","druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "guerison-de-groupe",
    name: { fr: "Guérison de groupe", en: "Mass Heal" },
    level: 9,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Une créature consentante que vous touchez est investie de vaillance. Jusqu’à la fin du sort, la créature est immunisée contre l’état Effrayé et reçoit autant de points de vie temporaires que votre modificateur de caractéristique d’incantation au début de chacun de ses tours.", en: "A willing creature you touch is imbued with bravery. Until the spell ends, the creature is immune to the Frightened condition and gains Temporary Hit Points equal to your spellcasting ability modifier at the start of each of its turns." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 1." },
  ...
  {
    id: "identification",
    name: { fr: "Identification", en: "Identify" },
    level: 1,
    school: "divination",
    castingTime: { fr: "1 minute ou rituel", en: "1 minute or Ritual" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une perle d’une valeur minimale de 100 po", en: "a pearl worth 100+ GP" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: true,
    description: { fr: "Vous touchez physiquement un objet tout au long de l’incantation. S’il s’agit d’un objet magique ou imprégné de magie, vous en apprenez les propriétés et savez les utiliser ; vous savez également si l’Harmonisation est requise et de combien de charges l’objet dispose, le cas échéant. Vous apprenez aussi quels sorts éventuels affectent l’objet. Si l’objet a été créé par un sort, vous apprenez lequel. Si au lieu d’un objet, vous touchez une créature pendant toute l’incantation, vous apprenez quels sorts éventuels l’affectent.", en: "You touch an object throughout the spell’s casting. If the object is a magic item or some other magical object, you learn its properties and how to use them, whether it requires Attunement, and how many charges it has, if any. You learn whether any ongoing spells are affecting the item and what they are. If the item was created by a spell, you learn that spell’s name.\nIf you instead touch a creature throughout the casting, you learn which ongoing spells, if any, are currently affecting it." },
    atHigherLevels: null,
    classes: ["bard","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "il-du-mage",
    name: { fr: "Œil du mage", en: "Arcane Eye" },
    level: 4,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une touffe de poils de chauve-souris", en: "a bit of bat fur" } },
    duration: { fr: "Concentration, jusqu’à 1 heure", en: "Concentration, up to 1 hour" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous créez un œil invulnérable et Invisible à portée, qui flotte dans les airs pour toute la durée. Vous recevez mentalement des informations visuelles transmises par l’œil, qui voit dans toutes les directions. Il dispose en outre de la Vision dans le noir sur 9 m. Par une action Bonus, vous pouvez déplacer l’œil d’un maximum de 9 m dans la direction de votre choix. Un obstacle solide bloque les déplacements de l’œil, mais celui-ci peut se glisser dans un interstice d’une largeur minimale de 2,5 cm.", en: "You create an Invisible, invulnerable eye within range that hovers for the duration. You mentally receive visual information from the eye, which can see in every direction. It also has Darkvision with a range of 30 feet.\nAs a Bonus Action, you can move the eye up to 30 feet in any direction. A solid barrier blocks the eye’s movement, but the eye can pass through an opening as small as 1 inch in diameter." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: false, s: true, m: true, material: { fr: "un peu de laine brute", en: "a bit of fleece" } },
    duration: { fr: "1 minute", en: "1 minute" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous créez à portée un son ou l’image d’un objet qui persiste pour toute la durée. La description qui suit\ndétaille les effets pour chacun. L’illusion prend fin si vous relancez ce sort. Une créature qui entreprend l’action Étude pour examiner le son ou l’image peut comprendre qu’il s’agit d’une illusion en réussissant un test d’Intelligence (Investigation) assorti de votre DD de sauvegarde des sorts. Une créature qui perce l’illusion continue de la percevoir, quoiqu’amoindrie. Son. Si vous créez un son, son volume peut aller du murmure au cri. Il peut prendre votre voix, celle de quelqu’un d’autre, imiter le rugissement du lion, un roulement de tambour ou une autre forme de votre choix. Le son se prolonge sans discontinuer pour toute la durée, à moins que vous préfériez ne le faire intervenir que de temps à autre jusqu’à la fin du sort. Image. Si vous créez l’image d’un objet, comme une chaise, des empreintes boueuses ou un petit coffre, il doit pouvoir tenir dans un Cube de 1,50 m. L’image ne peut créer ni son, ni lumière, ni odeur, ni autre effet sensoriel. Toute interaction physique avec l’image percera l’illusion, car elle n’est pas tangible.", en: "You create a sound or an image of an object within range that lasts for the duration. See the descriptions below for the effects of each. The illusion ends if you cast this spell again.\nIf a creature takes a Study action to examine the sound or image, the creature can determine that it is an illusion with a successful Intelligence (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the illusion becomes faint to the creature. Sound. If you create a sound, its volume can range from a whisper to a scream. It can be your voice, someone else’s voice, a lion’s roar, a beating of drums, or any other sound you choose. The sound continues unabated throughout the duration, or you can make discrete sounds at different times before the spell ends. Image. If you create an image of an object—such as a chair, muddy footprints, or a small chest—it must be no larger than a 5-foot Cube. The image can’t create sound, light, smell, or any other sensory effect. Physical interaction with the image reveals it to be an illusion, since things can pass through it." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "image-majeure",
    name: { fr: "Image majeure", en: "Major Image" },
    level: 3,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
  ...
  },
  {
    ...
    name: { fr: "Image silencieuse", en: "Silent Image" },
    level: 1,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    name: { fr: "Immobilisation de monstre", en: "Hold Monster" },
    level: 5,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "27 m", en: "90 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un brin de fer", en: "a straight piece of iron" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Choisissez une créature que vous voyez à portée. La cible doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Paralysé pour toute la durée du sort. La cible réitère le JS à la fin de chacun de ses tours et met un terme au sort sur elle-même en cas de réussite.", en: "Choose a creature that you can see within range. The target must succeed on a Wisdom saving throw or have the Paralyzed condition for the duration. At the end of each of its turns, the target repeats the save, ending the spell on itself on a success." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 5e .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 5." },
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "immobilisation-de-personne",
    name: { fr: "Immobilisation de personne", en: "Hold Person" },
    level: 2,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Choisissez un Humanoïde que vous voyez à portée. La cible doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Paralysé pour toute la durée du sort. La cible réitère le JS à la fin de chacun de ses tours et met un terme au sort sur elle-même en cas de réussite.", en: "Choose a Humanoid that you can see within range. The target must succeed on a Wisdom saving throw or have the Paralyzed condition for the duration. At the end of each of its turns, the target repeats the save, ending the spell on itself on a success." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler un Humanoïde supplémentaire par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. You can target one additional Humanoid for each spell slot level above 2." },
    classes: ["bard","cleric","druid","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "imprecation",
    name: { fr: "Imprécation", en: "Bane" },
    level: 1,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une goutte de sang", en: "a drop of blood" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Un maximum de trois créatures de votre choix parmi celles que vous voyez à portée effectuent un jet de sauvegarde de Charisme. Chaque fois qu’une créature ayant raté ce JS effectue un jet d’attaque ou un jet de sauvegarde avant la fin du sort, elle soustrait 1d4 au résultat correspondant.", en: "Up to three creatures of your choice that you can see within range must each make a Charisma saving throw. Whenever a target that fails this save makes an attack roll or a saving throw before the spell ends, the target must subtract 1d4 from the attack roll or save." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 1." },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous adressez un simple mot de commande à une créature que vous voyez à portée. La cible doit réussir un jet de sauvegarde de Sagesse sous peine de devoir s’y soumettre à son tour suivant. Choisissez votre ordre parmi les options suivantes : Approche. La cible se déplace dans votre direction par le chemin le plus court et direct, et termine son tour si elle se retrouve dans un rayon de 1,50 m de vous. Fuis. La cible consacre son tour à s’éloigner de vous par le moyen le plus rapide. Halte. À son tour, la cible ne se déplace pas, et n’entreprend ni action ni action Bonus. Lâche. La cible lâche ce qu’elle tient et termine son tour. Rampe. La cible subit l’état À terre et termine son tour.", en: "You speak a one-word command to a creature you can see within range. The target must succeed on a Wisdom saving throw or follow the command on its next turn. Choose the command from these options: Approach. The target moves toward you by the shortest and most direct route, ending its turn if it moves within 5 feet of you. Drop. The target drops whatever it is holding and then ends its turn. Flee. The target spends its turn moving away from you by the fastest available means. Grovel. The target has the Prone condition and then ends its turn. Halt. On its turn, the target doesn’t move and takes no action or Bonus Action." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez affecter une créature supplémentaire par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You can affect one additional creature for each spell slot level above 1." },
  ...
  },
  {
    ...
    name: { fr: "Invisibilité suprême", en: "Greater Invisibility" },
    level: 4,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "La créature que vous touchez physiquement reçoit l’état Invisible jusqu’à la fin du sort.", en: "A creature you touch has the Invisible condition until the spell ends." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Invocation d’animaux", en: "Conjure Animals" },
    level: 3,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    name: { fr: "Invocation d’élémentaire", en: "Conjure Elemental" },
    level: 5,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    name: { fr: "Invocation d’élémentaires mineurs", en: "Conjure Minor Elementals" },
    level: 4,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous invoquez des esprits issus des Plans Élémentaires qui volètent autour de vous pour toute la durée, sous forme d’une Émanation de 4,50 m. Jusqu’à la fin du sort, toute attaque que vous effectuez inflige 2d8 dégâts supplémentaires lorsque vous touchez une créature prise dans l’Émanation. Ces dégâts sont\nd’acide, de feu, de foudre ou de froid (vous choisissez en effectuant l’attaque). De plus, le sol dans l’Émanation constitue un Terrain difficile pour vos ennemis.", en: "You conjure spirits from the Elemental Planes that flit around you in a 15-foot Emanation for the duration. Until the spell ends, any attack you make deals an extra 2d8 damage when you hit a creature in the Emanation. This damage is Acid, Cold, Fire, or Lightning (your choice when you make the attack). In addition, the ground in the Emanation is Difficult Terrain for your enemies." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 4e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for each spell slot level above 4." },
    classes: ["druid","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Invocation d’êtres sylvestres", en: "Conjure Woodland Beings" },
    level: 4,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    name: { fr: "Invocation de céleste", en: "Conjure Celestial" },
    level: 7,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "27 m", en: "90 feet" },
  ...
  {
    id: "lenteur",
    name: { fr: "Lenteur", en: "Slow" },
    level: 3,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une goutte de mélasse", en: "a drop of molasses" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous altérez le temps autour d’un maximum de six créatures de votre choix dans un Cube de 12 m à portée. Chaque cible doit réussir un jet de sauvegarde de Sagesse sous peine d’être affectée par ce sort pour toute la durée. Une cible affectée voit sa Vitesse réduite de moitié, subit un malus de –2 à la CA et aux jets de sauvegarde de Dextérité, et ne peut pas jouer de Réactions. À ses tours, elle peut entreprendre une action ou une action Bonus, mais pas les deux, et elle ne peut effectuer qu’une attaque dans le cadre de l’action Attaque. Si elle lance un sort avec une composante somatique, il y a 25 % de chances que le sort échoue en raison de la torpeur de sa gestuelle. Une cible affectée réitère le JS à la fin de chacun de ses tours et met un terme au sort sur elle-même en cas de réussite.", en: "You alter time around up to six creatures of your choice in a 40-foot Cube within range. Each target must succeed on a Wisdom saving throw or be affected by this spell for the duration. An affected target’s Speed is halved, it takes a −2 penalty to AC and Dexterity saving throws, and it can’t take Reactions. On its turns, it can take either an action or a Bonus Action, not both, and it can make only one attack if it takes the Attack action. If it casts a spell with a Somatic component, there is a 25 percent chance the spell fails as a result of the target making the spell’s gestures too slowly.\nAn affected target repeats the save at the end of each of its turns, ending the spell on itself on a success." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Liberté de mouvement", en: "Freedom of Movement" },
    level: 4,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une bandelette de cuir", en: "a leather strap" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez une créature consentante. Pour toute la durée, les déplacements de la cible ne sont pas affectés par le Terrain difficile, et les sorts et effets magiques ne peuvent ni réduire sa Vitesse, ni lui infliger l’état Paralysé ou Entravé. La cible dispose aussi d’une Vitesse de nage égale à sa Vitesse. De plus, la cible peut consacrer 1,50 m de son déplacement à s’extraire automatiquement d’entraves non magiques, comme des menottes ou l’étreinte d’une créature qui lui impose l’état Agrippé.", en: "You touch a willing creature. For the duration, the target’s movement is unaffected by Difficult Terrain, and spells and other magical effects can neither reduce the target’s Speed nor cause the target to have the Paralyzed or Restrained conditions. The target also has a Swim Speed equal to its Speed.\nIn addition, the target can spend 5 feet of movement to automatically escape from nonmagical restraints, such as manacles or a creature imposing the Grappled condition on it." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 4e .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 4." },
  ...
  },
  {
    ...
    name: { fr: "Lien de protection", en: "Warding Bond" },
    level: 2,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "deux bagues de platine d’une valeur de 50 po chacune, que la cible et vous devez porter pour toute la durée", en: "a pair of platinum rings worth 50+ GP each, which you and the target must wear for the duration" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature consentante pour forger un lien magique entre elle et vous jusqu’à la fin du sort. Tant que la cible se trouve dans un rayon de 18 m de vous, elle reçoit un bonus de +1 à la CA et aux jets de sauvegarde, et bénéficie de la Résistance à tous les dégâts. Par ailleurs, chaque fois qu’elle subit des dégâts, vous en subissez autant. Le sort prend fin si vous tombez à 0 point de vie ou si la cible et vous vous retrouvez distants de plus de 18 m. Il prend également fin s’il est relancé sur l’une des deux créatures ainsi liées.", en: "You touch another creature that is willing and create a mystic connection between you and the target until the spell ends. While the target is within 60 feet of you, it gains a +1 bonus to AC and saving throws, and it has Resistance to all damage. Also, each time it takes damage, you take the same amount of damage.\nThe spell ends if you drop to 0 Hit Points or if you and the target become separated by more than 60 feet. It also ends if the spell is cast again on either of the connected creatures." },
    atHigherLevels: null,
    classes: ["cleric","paladin"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Lien télépathique", en: "Telepathic Bond" },
    level: 5,
    school: "divination",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "deux œufs", en: "two eggs" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: true,
    description: { fr: "Vous forgez un lien télépathique entre un maximum de huit créatures consentantes que vous choisissez à portée, chacune se retrouvant en relation psychique avec toutes les autres pour toute la durée. Les créatures incapables de communiquer par le biais d’une langue ne sont pas affectées par ce sort. Jusqu’à la fin du sort, les cibles peuvent communiquer par télépathie via le lien psychique, qu’elles parlent ou non une même langue. La communication, possible quelle que soit la distance, ne s’étend toutefois pas d’un plan d’existence à l’autre.", en: "You forge a telepathic link among up to eight willing creatures of your choice within range, psychically linking each creature to all the others for the duration. Creatures that can’t communicate in any languages aren’t affected by this spell.\nUntil the spell ends, the targets can communicate telepathically through the bond whether or not they share a language. The communication is possible over any distance, though it can’t extend to other planes of existence." },
    atHigherLevels: null,
    classes: ["bard","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Localisation d’animaux ou de plantes", en: "Locate Animals or Plants" },
    level: 2,
    school: "divination",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une touffe de poils de limier", en: "fur from a bloodhound" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: true,
    description: { fr: "Décrivez ou nommez une sorte de créature de type Bête ou Plante, ou une plante non magique. Vous savez alors dans quelle direction et à quelle distance se trouve, le cas échéant, la créature ou la plante de cette sorte la plus proche dans un rayon de 7,5 km.", en: "Describe or name a specific kind of Beast, Plant creature, or nonmagical plant. You learn the direction and distance to the closest creature or plant of that kind within 5 miles, if any are present." },
    atHigherLevels: null,
    classes: ["bard","druid","ranger"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Localisation de créature", en: "Locate Creature" },
    level: 4,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  {
    id: "lueur-d-espoir",
    name: { fr: "Lueur d’espoir", en: "Beacon of Hope" },
    level: 3,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Choisissez autant de créatures que vous le souhaitez à portée. Pour toute la durée, chaque cible a l’Avantage aux jets de sauvegarde de Sagesse et JS contre la mort, et récupère le maximum possible de points de vie chaque fois qu’on la soigne.", en: "Choose any number of creatures within range. For the duration, each target has Advantage on Wisdom saving throws and Death Saving Throws and regains the maximum number of Hit Points possible from any healing." },
    atHigherLevels: null,
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  {
    id: "lueurs-feeriques",
    name: { fr: "Lueurs féeriques", en: "Faerie Fire" },
    level: 1,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  {
    id: "lumiere-du-jour",
    name: { fr: "Lumière du jour", en: "Daylight" },
    level: 3,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Pour toute la durée, la lumière du soleil rayonne depuis un point à portée en emplissant une Sphère de 18 m de rayon. La Sphère constitue une zone de Lumière vive et produit une Lumière faible sur 18 m de plus. Au lieu de cela, vous pouvez lancer le sort sur un objet porté par personne, de manière à ce que les rayons du soleil emplissent une Émanation de 18 m centrée sur l’objet. Il suffit de recouvrir cet objet d’une surface opaque, comme une gamelle ou un heaume, pour bloquer la lumière du soleil. Si tout ou partie de ce sort chevauche la zone de Ténèbres créée par un sort du 3e niveau ou inférieur, cet autre sort est dissipé.", en: "For the duration, sunlight spreads from a point within range and fills a 60-foot-radius Sphere. The sunlight’s area is Bright Light and sheds Dim Light for an additional 60 feet.\nAlternatively, you cast the spell on an object that isn’t being worn or carried, causing the sunlight to fill a 60-foot Emanation originating from that object. Covering that object with something opaque, such as a bowl or helm, blocks the sunlight.\nIf any of this spell’s area overlaps with an area of Darkness created by a spell of level 3 or lower, that other spell is dispelled." },
    atHigherLevels: null,
  ...
  {
    id: "mains-brulantes",
    name: { fr: "Mains brûlantes", en: "Burning Hands" },
    level: 1,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une fine nappe de flammes jaillit de vous. Chaque créature prise dans un Cône de 4,50 m effectue un jet de sauvegarde de Dextérité et subit 3d6 dégâts de feu en cas d’échec, la moitié en cas de réussite. Les objets inflammables pris dans le Cône s’embrasent s’ils ne sont portés par personne.", en: "A thin sheet of flames shoots forth from you. Each creature in a 15-foot Cone makes a Dexterity saving throw, taking 3d6 Fire damage on a failed save or half as much damage on a successful one.\nFlammable objects in the Cone that aren’t being worn or carried start burning." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d6 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d6 for each spell slot level above 1." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "malediction",
    name: { fr: "Malédiction", en: "Bestow Curse" },
    level: 3,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
  ...
  },
  {
    ...
    name: { fr: "Marque du chasseur", en: "Hunter’s Mark" },
    level: 1,
    school: "divination",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "27 m", en: "90 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous désignez magiquement une créature que vous voyez à portée comme votre proie. Jusqu’à la fin du sort, vous infligez 1d6 dégâts de force à la cible chaque fois que vous la touchez avec un jet d’attaque. Vous avez aussi l’Avantage aux tests de Sagesse (Perception ou Survie) visant à la trouver. Si la cible tombe à 0 point de vie avant la fin du sort, vous pouvez par une action Bonus déplacer la marque vers une autre créature que vous voyez à portée.", en: "You magically mark one creature you can see within range as your quarry. Until the spell ends, you deal an extra 1d6 Force damage to the target whenever you hit it with an attack roll. You also have Advantage on any Wisdom (Perception or Survival) check you make to find it.\nIf the target drops to 0 Hit Points before this spell ends, you can take a Bonus Action to move the mark to a new creature you can see within range." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vot re Concentration peut persister plus longtemps avec un emplacement du 3e ou 4e niveau (jusqu’à 8 heures), ou du 5e et supérieur (24 heures).", en: "Using a Higher-Level Spell Slot. Your Concentration can last longer with a spell slot of level 3–4 (up to 8 hours) or 5+ (up to 24 hours)." },
    classes: ["ranger"],
    source: 'srd-5.2.1',
  },
  {
    id: "mauvais-il",
    name: { fr: "Mauvais œil", en: "Eyebite" },
    level: 6,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: false, s: true, m: true, material: { fr: "du fil de cuivre", en: "a copper wire" } },
    duration: { fr: "1 round", en: "1 round" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous pointez le doigt vers une créature à portée et murmurez un message. La cible (et seulement elle) entend votre message et peut y répondre par un murmure audible de votre seule personne. Vous pouvez lancer ce sort à travers des objets solides si vous connaissez la cible et savez qu’elle se trouve derrière ces obstacles. Le silence magique, 30 cm de pierre, de métal ou de bois, ou une simple feuille de plomb suffisent à bloquer le sort.", en: "You point toward a creature within range and whisper a message. The target (and only the target) hears the message and can reply in a whisper that only you can hear.\nYou can cast this spell through solid objects if you are familiar with the target and know it is beyond the barrier. Magical silence; 1 foot of stone, metal, or wood; or a thin sheet of lead blocks the spell." },
    atHigherLevels: null,
    classes: ["bard","druid","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "messager-animal",
    name: { fr: "Messager animal", en: "Animal Messenger" },
    level: 2,
    school: "enchantment",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: false,
    ritual: true,
    description: { fr: "La Bête de taille TP de votre choix parmi celles que vous voyez à portée doit réussir un jet de sauvegarde de Charisme, sans quoi elle s’efforce de livrer le message que vous lui confiez (si son facteur de puissance n’est pas 0, elle réussit automatiquement). Vous spécifiez un lieu que vous avez déjà visité et un destinataire qui correspond à une description générale, tel que « une personne vêtue de l’uniforme du guet » ou « un nain roux coiffé d’un chapeau pointu. » Vous lui communiquez de plus un message limité à vingt-cinq mots. La Bête voyage vers le lieu spécifié tant que le sort est actif, ce qui lui permet de parcourir 75 km en 24 heures dans le cas d’un animal volant, 37,5 km sinon. Quand la Bête arrive à destination, elle livre votre message à la créature décrite, en imitant votre manière de communiquer. Si elle ne parvient pas à destination avant la fin du sort, le message est perdu et la Bête revient à l’endroit de l’incantation.", en: "A Tiny Beast of your choice that you can see within range must succeed on a Charisma saving throw, or it attempts to deliver a message for you (if the target’s Challenge Rating isn’t 0, it automatically succeeds). You specify a location you have visited and a recipient who matches a general description, such as “a person dressed in the uniform of the town guard” or “a red-haired dwarf wearing a pointed hat.” You also communicate a message of up to twenty-five words. The Beast travels for the duration toward the specified location, covering about 25 miles per 24 hours or 50 miles if the Beast can fly.\nWhen the Beast arrives, it delivers your message to the creature that you described, mimicking your communication. If the Beast doesn’t reach its destination before the spell ends, the message is lost, and the Beast returns to where you cast the spell." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. La durée augmente de 48 heures par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The spell’s duration increases by 48 hours for each spell slot level above 2." },
    classes: ["bard","druid","ranger"],
    source: 'srd-5.2.1',
  },
  {
    id: "metal-brulant",
    name: { fr: "Métal brûlant", en: "Heat Metal" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un bout de fer et une flamme", en: "a piece of iron and a flame" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Choisissez un objet manufacturé en métal, tel qu’une arme, ou une armure métallique intermédiaire ou lourde, que vous voyez à portée. Vous faites chauffer l’objet au rouge incandescent. Toute créature en contact physique avec l’objet subit 2d8 dégâts de feu à l’incantation du sort. Jusqu’à la fin du sort, vous pouvez appliquer de nouveau ces dégâts par une action Bonus à chacun de vos tours suivants, à condition que l’objet soit à portée. Une créature qui tient un tel objet ou en est vêtue et qui subit les dégâts correspondants doit réussir un jet de sauvegarde de Constitution sous peine de lâcher l’objet (si elle en a la possibilité). Si elle ne peut pas le lâcher, elle a le Désavantage à ses jets d’attaque et tests de caractéristique jusqu’au début de votre tour suivant.", en: "Choose a manufactured metal object, such as a metal weapon or a suit of Heavy or Medium metal armor, that you can see within range. You cause the object to glow red-hot. Any creature in physical contact with the object takes 2d8 Fire damage when you cast the spell. Until the spell ends, you can take a Bonus Action on each of your later turns to deal this damage again if the object is within range.\nIf a creature is holding or wearing the object and takes the damage from it, the creature must succeed on a Constitution saving throw or drop the object if it can. If it doesn’t drop the object, it has Disadvantage on attack rolls and ability checks until the start of your next turn." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for each spell slot level above 2." },
    classes: ["bard","druid"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Métamorphose animale", en: "Animal Shapes" },
    level: 8,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  },
  {
    ...
    name: { fr: "Modification d’apparence", en: "Alter Self" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    name: { fr: "Modification de mémoire", en: "Modify Memory" },
    level: 5,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
  ...
  },
  {
    ...
    concentration: false,
    ritual: true,
    description: { fr: "Une créature chevaline quasi réelle de taille G se manifeste au sol en un espace inoccupé que vous choisissez à portée. Vous décidez de son apparence, sachant qu’elle est équipée d’une selle, de mors et d’une bride. Tout l’équipement créé par le sort disparaît dans une bouffée de fumée si on l’éloigne de plus de 3 m de la monture. Pour toute la durée, vous ou une créature que vous désignez pouvez chevaucher la monture. La monture reprend le profil du cheval de selle (cf. « Monstres »), si ce n’est que sa Vitesse est de 30 m et qu’elle peut couvrir 19,5 km en une heure. Quand le sort prend fin, la monture s’efface progressivement en laissant à son cavalier 1 minute pour en descendre. Le sort prend fin prématurément si la monture subit le moindre dégât.", en: "A Large, quasi-real, horselike creature appears on the ground in an unoccupied space of your choice within range. You decide the creature’s appearance, and it is equipped with a saddle, bit, and bridle. Any of the equipment created by the spell vanishes in a puff of smoke if it is carried more than 10 feet away from the steed.\nFor the duration, you or a creature you choose can ride the steed. The steed uses the Riding Horse stat block (see “Monsters”), except it has a Speed of 100 feet and can travel 13 miles in an hour. When the spell ends, the steed gradually fades, giving the rider 1 minute to dismount. The spell ends early if the steed takes any damage." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "moquerie-cruelle",
    name: { fr: "Moquerie cruelle", en: "Vicious Mockery" },
    level: 0,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous adressez un chapelet d’insultes assaisonnées de subtils enchantements à une créature que vous voyez ou entendez à portée. La cible doit réussir un jet de sauvegarde de Sagesse sous peine de subir 1d6 dégâts psychiques, ainsi que le Désavantage à son prochain jet d’attaque intervenant avant la fin de son tour suivant.", en: "You unleash a string of insults laced with subtle enchantments at one creature you can see or hear within range. The target must succeed on a Wisdom saving throw or take 1d6 Psychic damage and have Disadvantage on the next attack roll it makes before the end of its next turn." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Les dégâts augmentent de 1d6 lorsque vous atteignez les niveaux 5 (2d6), 11 (3d6) et 17 (4d6).", en: "Cantrip Upgrade. The damage increases by 1d6 when you reach levels 5 (2d6), 11 (3d6), and 17 (4d6)." },
    classes: ["bard"],
    source: 'srd-5.2.1',
  },
  {
    id: "mot-de-guerison",
    name: { fr: "Mot de guérison", en: "Healing Word" },
    level: 1,
    school: "abjuration",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "La créature de votre choix parmi celles que vous voyez à portée récupère des points de vie : 2d4 + votre modificateur de caractéristique d’incantation.", en: "A creature of your choice that you can see within range regains Hit Points equal to 2d4 plus your spellcasting ability modifier." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les soins augmentent de 2d4 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The healing increases by 2d4 for each spell slot level above 1." },
    classes: ["bard","cleric","druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "mot-de-guerison-de-groupe",
    name: { fr: "Mot de guérison de groupe", en: "Mass Healing Word" },
    level: 3,
    school: "abjuration",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Un maximum de six créatures de votre choix parmi celles que vous voyez à portée récupèrent des points de vie : 2d4 + votre modificateur de caractéristique d’incantation.", en: "Up to six creatures of your choice that you can see within range regain Hit Points equal to 2d4 plus your spellcasting ability modifier." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les soins augmentent de 1d4 par niveau d’emplacement au-delà du 3e .", en: "Using a Higher-Level Spell Slot. The healing increases by 1d4 for each spell slot level above 3." },
    classes: ["bard","cleric"],
    source: 'srd-5.2.1',
  },
  {
    id: "mot-de-pouvoir-etourdissant",
    name: { fr: "Mot de pouvoir étourdissant", en: "Power Word Stun" },
    level: 8,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous assaillez l’esprit d’une créature que vous voyez à portée. Si la cible choisie est dotée de 150 points de vie ou moins, elle subit l’état Étourdi. Dans le cas contraire, sa Vitesse tombe à 0 jusqu’au début de votre tour suivant. La cible Étourdie effectue un jet de sauvegarde de Constitution à la fin de chacun de ses tours et met un terme à cet état en cas de réussite.", en: "You overwhelm the mind of one creature you can see within range. If the target has 150 Hit Points or fewer, it has the Stunned condition. Otherwise, its Speed is 0 until the start of your next turn.\nThe Stunned target makes a Constitution saving throw at the end of each of its turns, ending the condition on itself on a success." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "mot-de-pouvoir-guerisseur",
    name: { fr: "Mot de pouvoir guérisseur", en: "Power Word Heal" },
    level: 9,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une vague d’énergies de guérison baigne une créature que vous voyez à portée. La cible récupère tous ses points de vie. Si la créature a l’état Charmé, Effrayé, Empoisonné, Étourdi ou Paralysé, cet état prend fin. Si la créature a l’état À terre, elle peut jouer sa Réaction pour se relever.", en: "A wave of healing energy washes over one creature you can see within range. The target regains all its Hit Points. If the creature has the Charmed, Frightened, Paralyzed, Poisoned, or Stunned condition, the condition ends. If the creature has the Prone condition, it can use its Reaction to stand up." },
    atHigherLevels: null,
    classes: ["bard","cleric"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Mot de pouvoir mortel", en: "Power Word Kill" },
    level: 9,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "La mort s’impose à une créature que vous voyez à portée. Si la cible choisie est dotée de 100 points de vie ou moins, elle meurt. Dans le cas contraire, elle subit 12d12 dégâts psychiques.", en: "You compel one creature you can see within range to die. If the target has 100 Hit Points or fewer, it dies. Otherwise, it takes 12d12 Psychic damage." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "motif-hypnotique",
    name: { fr: "Motif hypnotique", en: "Hypnotic Pattern" },
    level: 3,
    school: "illusion",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: false, s: true, m: true, material: { fr: "une pincée de confettis", en: "a pinch of confetti" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous créez un motif animé de couleurs occupant un Cube de 9 m à portée. Le motif apparaît un instant et disparaît aussitôt. Chaque créature prise dans la zone, si elle voit le motif, doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Charmé pour toute la durée du sort. Tant qu’elle est ainsi Charmée, la créature subit l’état Neutralisé et sa Vitesse est de 0. Le sort prend fin pour une créature affectée si elle subit des dégâts ou si quelqu’un d’autre consacre une action à la sortir de son hébétude.", en: "You create a twisting pattern of colors in a 30-foot Cube within range. The pattern appears for a moment and vanishes. Each creature in the area who can see the pattern must succeed on a Wisdom saving throw or have the Charmed condition for the duration. While Charmed, the creature has the Incapacitated condition and a Speed of 0.\nThe spell ends for an affected creature if it takes any damage or if someone else uses an action to shake the creature out of its stupor." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "mur-d-epines",
    name: { fr: "Mur d’épines", en: "Wall of Thorns" },
    level: 6,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une poignée d’épines", en: "a handful of thorns" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous créez un mur fait d’un enchevêtrement végétal hérissé d’épines acérées. Le mur apparaît à portée sur une surface solide et persiste pour toute la durée. Vous pouvez ainsi ériger un mur dont l’épaisseur n’excède pas 1,50 m ; pour le reste, vous avez le choix entre un mur droit long d’un maximum de 18 m et haut de 3 m ou moins, et un mur circulaire dont le diamètre et la hauteur ne dépassent pas 6 m. Le mur bloque le champ de vision. Quand le mur apparaît, chaque créature prise dans sa zone effectue un jet de sauvegarde de Dextérité et subit 7d8 dégâts perforants en cas d’échec, la moitié en cas de réussite. Une créature peut se déplacer à travers ces ronces, mais l’opération est lente et douloureuse. Toute distance parcourue à travers le mur lui coûte le quadruple en termes de déplacement. De plus, la première fois d’un tour qu’une créature pénètre dans la haie ou qu’elle y termine son propre tour, elle effectue un jet de sauvegarde de Dextérité et subit 7d8 dégâts tranchants en cas d’échec, la moitié en cas de réussite. Une même créature n’effectue en aucun cas ce JS plus d’une fois par tour.", en: "You create a wall of tangled brush bristling with needle-sharp thorns. The wall appears within range on a solid surface and lasts for the duration. You choose to make the wall up to 60 feet long, 10 feet high, and 5 feet thick or a circle that has a 20-foot diameter and is up to 20 feet high and 5 feet thick. The wall blocks line of sight.\nWhen the wall appears, each creature in its area makes a Dexterity saving throw, taking 7d8 Piercing damage on a failed save or half as much damage on a successful one.\nA creature can move through the wall, albeit slowly and painfully. For every 1 foot a creature moves through the wall, it must spend 4 feet of movement. Furthermore, the first time a creature enters a space in the wall on a turn or ends its turn there, the creature makes a Dexterity saving throw, taking 7d8 Slashing damage on a failed save or half as much damage on a successful one. A creature makes this save only once per turn." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts des deux types augmentent de 1d8 par niveau d’emplacement au-delà du 6e .", en: "Using a Higher-Level Spell Slot. Both types of damage increase by 1d8 for each spell slot level above 6." },
    classes: ["druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "mur-de-feu",
    name: { fr: "Mur de feu", en: "Wall of Fire" },
    level: 4,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un morceau de charbon", en: "a piece of charcoal" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous créez un mur de flammes sur une surface solide à portée. Vous pouvez ainsi ériger un mur dont la hauteur n’excède pas 6 m et l’épaisseur 30 cm ; pour le reste, vous avez le choix entre un mur droit long d’un maximum de 18 m et un mur circulaire dont le diamètre ne dépasse pas 6 m. Ce mur opaque persiste pour toute la durée. Quand le mur apparaît, chaque créature prise dans sa zone effectue un jet de sauvegarde de Dextérité et subit 5d8 dégâts de feu en cas d’échec, la moitié en cas de réussite. L’un des côtés du mur que vous choisissez à l’incantation du sort inflige 5d8 dégâts de feu à toute créature qui termine son tour à 3 m ou moins de ce côté ou dans le mur. Une créature qui pénètre dans le mur pour la première fois d’un tour ou qui y termine son tour subit ces mêmes dégâts. L’autre côté du mur n’inflige pas de dégâts.", en: "You create a wall of fire on a solid surface within range. You can make the wall up to 60 feet long, 20 feet high, and 1 foot thick, or a ringed wall up to 20 feet in diameter, 20 feet high, and 1 foot thick. The wall is opaque and lasts for the duration.\nWhen the wall appears, each creature in its area makes a Dexterity saving throw, taking 5d8 Fire damage on a failed save or half as much damage on a successful one.\nOne side of the wall, selected by you when you cast this spell, deals 5d8 Fire damage to each creature that ends its turn within 10 feet of that side or inside the wall. A creature takes the same damage when it enters the wall for the first time on a turn or ends its turn there. The other side of the wall deals no damage." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 4e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for each spell slot level above 4." },
    classes: ["druid","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "mur-de-force",
    name: { fr: "Mur de force", en: "Wall of Force" },
    level: 5,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un éclat de verre", en: "a shard of glass" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: false,
    description: { fr: "Un mur de force invisible se matérialise en un point que vous choisissez à portée. Le mur se présente dans l’orientation de votre choix, horizontal ou vertical, voire complètement de biais. Il peut rester en suspension ou reposer sur une surface solide. Vous pouvez le façonner en dôme hémisphérique ou en globe d’un rayon maximal de 3 m, ou en faire une surface plane composée de dix pans de 3 m sur 3. Chaque pan doit être contigu avec un autre. Quelle que soit sa forme, le mur est épais de 6 mm et persiste pour toute la durée. Si le mur traverse l’espace d’une créature à son apparition, la créature est repoussée du côté du mur que vous choisissez.\nRien ne peut franchir physiquement le mur. Il est immunisé contre tous les dégâts et insensible à dissipation de la magie. Le sort désintégration détruit en revanche le mur instantanément. Ce mur s’étend en outre sur le Plan Éthéré, ce qui empêche le voyage éthéré le traversant.", en: "An Invisible wall of force springs into existence at a point you choose within range. The wall appears in any orientation you choose, as a horizontal or vertical barrier or at an angle. It can be free floating or resting on a solid surface. You can form it into a hemispherical dome or a globe with a radius of up to 10 feet, or you can shape a flat surface made up of ten 10-foot-by-10-foot panels. Each panel must be contiguous with another panel. In any form, the wall is 1/4 inch thick and lasts for the duration. If the wall cuts through a creature’s space when it appears, the creature is pushed to one side of the wall (you choose which side).\nNothing can physically pass through the wall. It is immune to all damage and can’t be dispelled by Dispel Magic. A Disintegrate spell destroys the wall instantly, however. The wall also extends into the Ethereal Plane and blocks ethereal travel through the wall." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "mur-prismatique",
    name: { fr: "Mur prismatique", en: "Prismatic Wall" },
    level: 9,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  },
  {
    ...
    name: { fr: "Murmures dissonants", en: "Dissonant Whispers" },
    level: 1,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une créature que vous choisissez parmi celles que vous voyez à portée perçoit intérieurement une mélodie discordante. La cible effectue un jet de sauvegarde de Sagesse. Elle subit 3d6 dégâts psychiques en cas d’échec et doit aussitôt jouer sa Réaction si disponible pour s’éloigner de vous autant qu’elle le peut, par le chemin le plus sûr. En cas de réussite, la cible subit uniquement la moitié de ces dégâts.", en: "One creature of your choice that you can see within range hears a discordant melody in its mind. The target makes a Wisdom saving throw. On a failed save, it takes 3d6 Psychic damage and must immediately use its Reaction, if available, to move as far away from you as it can, using the safest route. On a successful save, the target takes half as much damage only." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d6 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d6 for each spell slot level above 1." },
    classes: ["bard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Mythes et légendes", en: "Legend Lore" },
    level: 5,
    school: "divination",
    castingTime: { fr: "10 minutes", en: "10 minutes" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "de l’encens d’une valeur mini- male de 250 po, que le sort détruit, et quatre lamelles d’ivoire d’une valeur minimale de 50 po chacune", en: "incense worth 250+ GP, which the spell consumes, and four ivory strips worth 50+ GP each" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Nommez ou décrivez un élément notoire : personne, lieu ou objet. Le sort vous fait prendre brièvement conscience d’un fait important (décrit par le MJ) concernant l’élément mentionné. Cette bribe de savoir peut consister en des détails essentiels, des révélations cocasses, voire quelque secret toujours resté méconnu. Plus vous en savez déjà sur l’élément, plus précises et détaillées seront les informations transmises. Les détails révélés sont justes, mais sont parfois formulés de manière imagée ou par le biais de vers (à l’appréciation du MJ). Si l’élément retenu n’est pas véritablement notoire, vous n’entendez que quelques notes tristes de trombone et le sort prend fin.", en: "Name or describe a famous person, place, or object. The spell brings to your mind a brief summary of the significant lore about that famous thing, as described by the GM.\nThe lore might consist of important details, amusing revelations, or even secret lore that has never been widely known. The more information you already know about the thing, the more precise and detailed the information you receive is. That information is accurate but might be couched in figurative language or poetry, as determined by the GM.\nIf the famous thing you chose isn’t actually famous, you hear sad musical notes played on a trombone, and the spell fails." },
    atHigherLevels: null,
    classes: ["bard","cleric","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Nappe de brouillard", en: "Fog Cloud" },
    level: 1,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous créez une Sphère de 6 m de rayon constituée de brouillard, centrée sur un point à portée. La Sphère présente une Visibilité nulle. Elle persiste pour toute la durée, à moins qu’un vent fort (comme celui engendré par bourrasque) la disperse.", en: "You create a 20-foot-radius Sphere of fog centered on a point within range. The Sphere is Heavily Obscured. It lasts for the duration or until a strong wind (such as one created by Gust of Wind) disperses it." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Le rayon du brouillard augmente de 6 m par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The fog’s radius increases by 20 feet for each spell slot level above 1." },
    classes: ["druid","ranger","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "nuage-incendiaire",
    name: { fr: "Nuage incendiaire", en: "Incendiary Cloud" },
    level: 8,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "45 m", en: "150 feet" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Un nuage tourbillonnant de fumée se manifeste, chargé de flammèches, sous forme d’une Sphère de 6 m de rayon centrée sur un point à portée. La zone du nuage présente une Visibilité nulle. Elle persiste pour toute la durée, à moins qu’un vent fort (comme celui engendré par bourrasque) la disperse. Chaque créature prise dans le nuage à son apparition effectue un jet de sauvegarde de Dextérité et subit 10d8 dégâts de feu en cas d’échec, la moitié en cas de réussite. Toute créature qui voit la Sphère se déplacer dans son espace, ou qui pénètre dans la Sphère ou y termine son tour, est également soumise à ce JS. Une même créature n’effectue en aucun cas ce JS plus d’une fois par tour.", en: "A swirling cloud of embers and smoke fills a 20-foot-radius Sphere centered on a point within range. The cloud’s area is Heavily Obscured. It lasts for the duration or until a strong wind (like that created by Gust of Wind) disperses it.\nWhen the cloud appears, each creature in it makes a Dexterity saving throw, taking 10d8 Fire damage on a failed save or half as much damage on a successful one. A creature must also make this save when the Sphere moves into its space and when it enters the Sphere or ends its turn there. A creature makes this save only once per turn.\nThe cloud moves 10 feet away from you in a direction you choose at the start of each of your turns." },
    atHigherLevels: null,
    classes: ["druid","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "nuee-de-meteores",
    name: { fr: "Nuée de météores", en: "Meteor Swarm" },
    level: 9,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "1,5 km", en: "1 mile" },
  ...
  {
    id: "parole-divine",
    name: { fr: "Parole divine", en: "Divine Word" },
    level: 7,
    school: "evocation",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous prononcez une parole porteuse de la puissance des Plans Supérieurs. Chaque créature que vous choisissez à portée effectue un jet de sauvegarde de Charisme. En cas d’échec, une cible dotée de 50 points de vie ou moins subit un effet qui dépend de ses points de vie actuels, comme indiqué sur la table Effets de parole divine. Quels que soient ses points de vie actuels, une cible Céleste, Élémentaire, Fée ou Fiélon qui rate son JS est renvoyée d’office dans son plan d’origine (s’il ne s’y trouve pas déjà) et ne peut revenir sur votre plan actuel pendant 24 heures, sauf par le biais du sort souhait. Effets de parole divine Points de vieEffet 0–20La cible meurt. 21–30La cible subit les états Assourdi, Aveuglé et Étourdi pendant 1 heure. 31–40La cible subit les états Assourdi et Aveuglé pendant 10 minutes. 41–50La cible subit l’état Assourdi pendant 1 minute.", en: "You utter a word imbued with power from the Upper Planes. Each creature of your choice in range makes a Charisma saving throw. On a failed save, a target that has 50 Hit Points or fewer suffers an effect based on its current Hit Points, as shown in the Divine Word Effects table. Regardless of its Hit Points, a Celestial, an Elemental, a Fey, or a Fiend target that fails its save is forced back to its plane of origin (if it isn’t there already) and can’t return to the current plane for 24 hours by any means short of a Wish spell. Divine Word Effects Hit PointsEffect 0–20The target dies. 21–30The target has the Blinded, Deafened, and Stunned conditions for 1 hour. 31–40The target has the Blinded and Deafened conditions for 10 minutes. 41–50The target has the Deafened condition for 1 minute." },
    atHigherLevels: null,
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Passage par les arbres", en: "Tree Stride" },
    level: 5,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous recevez la faculté d’entrer dans un arbre et de vous y déplacer pour atteindre un autre arbre du même type distant d’un maximum de 150 m. Les deux arbres doivent être vivants et d’une catégorie de taille supérieure ou égale à la vôtre. Entrer dans un arbre nécessite d’y consacrer 1,50 m de déplacement. Vous prenez aussitôt conscience de la position de tous les autres arbres de la même essence dans un rayon de 150 m et, lors du déplacement qui vous permet de pénétrer dans l’arbre, vous avez alors le choix entre passer dans l’un de ces arbres ou ressortir par celui dans lequel vous venez d’entrer. Si vous consacrez 1,50 m de déplacement supplémentaire, vous apparaissez à l’endroit de votre choix dans un rayon de 1,50 m de l’arbre de destination. S’il ne vous reste aucun déplacement, vous réapparaissez dans un rayon de 1,50 m de l’arbre de départ. Vous ne pouvez utiliser cette faculté de transport qu’une seule fois à chacun de vos tours. Vous devez terminer chaque tour à l’extérieur d’un arbre.", en: "You gain the ability to enter a tree and move from inside it to inside another tree of the same kind within 500 feet. Both trees must be living and at least the same size as you. You must use 5 feet of movement to enter a tree. You instantly know the location of all other trees of the same kind within 500 feet and, as part of the move used to enter the tree, can either pass into one of those trees or step out of the tree you’re in. You appear in a spot of your choice within 5 feet of the destination tree, using another 5 feet of movement. If you have no movement left, you appear within 5 feet of the tree you entered.\nYou can use this transportation ability only once on each of your turns. You must end each turn outside a tree." },
    atHigherLevels: null,
    classes: ["druid","ranger"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Passage sans trace", en: "Pass without Trace" },
    level: 2,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "les cendres d’une feuille de gui calcinée", en: "ashes from burned mistletoe" } },
    duration: { fr: "Concentration, jusqu’à 1 heure", en: "Concentration, up to 1 hour" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous projetez pour toute la durée une aura de camouflage sous forme d’une Émanation de 9 m. Pour toute la durée, chaque créature que vous désignez dans un rayon de 9 m (y compris vous) bénéficie d’un bonus de +10 aux tests de Dextérité (Discrétion) et ne laisse pas de traces.", en: "You radiate a concealing aura in a 30-foot Emanation for the duration. While in the aura, you and each creature you choose have a +10 bonus to Dexterity (Stealth) checks and leave no tracks." },
    atHigherLevels: null,
    classes: ["druid","ranger"],
    source: 'srd-5.2.1',
  },
  {
    id: "passe-muraille",
    name: { fr: "Passe-muraille", en: "Passwall" },
    level: 5,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une pincée de graines de sésame", en: "a pinch of sesame seeds" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Un passage se forme en un point que vous voyez sur une surface de bois, de plâtre ou de pierre (comme un mur, un plafond ou un sol) à portée, et persiste pour toute la durée. Vous choisissez les dimensions de l’ouverture : jusqu’à 1,50 m de large, 2,40 m de haut et 6 m de profondeur. Le passage n’engendre aucune instabilité dans la structure qui l’entoure. Lorsque le passage disparaît, tous les objets et créatures qui s’y trouvent encore sont éjectés sans heurt dans les espaces inoccupés les plus proches de la surface affectée.", en: "A passage appears at a point that you can see on a wooden, plaster, or stone surface (such as a wall, ceiling, or floor) within range and lasts for the duration. You choose the opening’s dimensions: up to 5 feet wide, 8 feet tall, and 20 feet deep. The passage creates no instability in a structure surrounding it.\nWhen the opening disappears, any creatures or objects still in the passage created by the spell are safely ejected to an unoccupied space nearest to the surface on which you cast the spell." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une goutte de bitume et une araignée", en: "a drop of bitumen and a spider" } },
    duration: { fr: "Concentration, jusqu’à 1 heure", en: "Concentration, up to 1 hour" },
    concentration: true,
    ritual: false,
    description: { fr: "Jusqu’à la fin du sort, une créature consentante que vous touchez reçoit la capacité de se déplacer dans toutes les directions le long des surfaces verticales, ainsi que sur les plafonds, tout en gardant les mains libres. La cible acquiert en outre une Vitesse d’escalade égale à sa Vitesse.", en: "Until the spell ends, one willing creature you touch gains the ability to move up, down, and across vertical surfaces and along ceilings, while leaving its hands free. The target also gains a Climb Speed equal to its Speed." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 2." },
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "peau-d-ecorce",
    name: { fr: "Peau d’écorce", en: "Barkskin" },
    level: 2,
    school: "transmutation",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une poignée d’écorce", en: "a handful of bark" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez une créature consentante. Jusqu’à la fin du sort, la peau de la cible adopte un aspect d’écorce et sa classe d’armure passe à 17 si elle est inférieure à cette valeur.", en: "You touch a willing creature. Until the spell ends, the target’s skin assumes a bark-like appearance, and the target has an Armor Class of 17 if its AC is lower than that." },
    atHigherLevels: null,
    classes: ["druid","ranger"],
    source: 'srd-5.2.1',
  },
  {
    id: "peau-de-pierre",
    name: { fr: "Peau de pierre", en: "Stoneskin" },
    level: 4,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "poudre de diamant d’une valeur minimale de 100 po, que le sort détruit", en: "diamond dust worth 100+ GP, which the spell consumes" } },
    duration: { fr: "Concentration, jusqu’à 1 heure", en: "Concentration, up to 1 hour" },
    concentration: true,
    ritual: false,
    description: { fr: "Jusqu’à la fin du sort, une créature consentante que vous touchez physiquement a la Résistance aux dégâts contondants, perforants et tranchants.", en: "Until the spell ends, one willing creature you touch has Resistance to Bludgeoning, Piercing, and Slashing damage." },
    atHigherLevels: null,
    classes: ["druid","ranger","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Poigne électrique", en: "Shocking Grasp" },
    level: 0,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "La foudre jaillit de vous vers une créature que vous tentez de toucher. Effectuez une attaque de sort au corps à corps contre la cible. Si l’attaque touche, la cible subit 1d8 dégâts de foudre et ne peut pas effectuer d’attaque d’Opportunité jusqu’au début de son tour suivant.", en: "Lightning springs from you to a creature that you try to touch. Make a melee spell attack against the target. On a hit, the target takes 1d8 Lightning damage, and it can’t make Opportunity Attacks until the start of its next turn." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Les dégâts augmentent de 1d8 lorsque vous atteignez les niveaux 5 (2d8), 11 (3d8) et 17 (4d8).", en: "Cantrip Upgrade. The damage increases by 1d8 when you reach levels 5 (2d8), 11 (3d8), and 17 (4d8)." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "premeditation",
    name: { fr: "Préméditation", en: "Contingency" },
    level: 6,
    school: "abjuration",
    castingTime: { fr: "10 minutes", en: "10 minutes" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une statuette en ivoire incrustée de gemmes, à votre image, d’une valeur minimale de 1 500 po", en: "a gem-encrusted statuette of yourself worth 1,500+ GP" } },
    duration: { fr: "10 jours", en: "10 days" },
    concentration: false,
    ritual: false,
    description: { fr: "Choisissez un sort du 5e niveau ou inférieur que vous pouvez lancer, dont le temps d’incantation est d’une action et qui peut vous cibler. Vous lancez le sort concerné, qu’on appellera « sort prémédité », dans le cadre de l’incantation de préméditation, et acquittez les emplacements des deux sorts. Le sort prémédité n’agit toutefois pas aussitôt. Au lieu de cela, il ne prendra effet que lorsqu’un déclencheur précis se présentera. Vous décrivez ce déclencheur à l’incantation des deux sorts. Exemple : une préméditation lancée en conjonction avec respiration aquatique pourrait stipuler que respiration aquatique prendra effet lorsque vous serez englouti par les eaux ou un liquide comparable. Le sort prémédité prend effet aussitôt après que les conditions sont réunies pour la première fois, que vous le vouliez ou non, puis la préméditation prend fin. Le sort prémédité ne prend effet que sur vous, même s’il est susceptible d’avoir d’autres cibles en temps normal. Vous ne pouvez recourir qu’à un sort de préméditation à la fois. Si vous relancez ce sort, la préméditation qui vous affectait déjà prend fin. La préméditation prend également fin si sa composante matérielle n’est plus sur vous.", en: "Choose a spell of level 5 or lower that you can cast, that has a casting time of an action, and that can target you. You cast that spell—called the contingent spell—as part of casting Contingency, expending spell slots for both, but the contingent spell doesn’t come into effect. Instead, it takes effect when a certain trigger occurs. You describe that trigger when you cast the two spells. For example, a Contingency cast with Water Breathing might stipulate that Water Breathing comes into effect when you are engulfed in water or a similar liquid.\nThe contingent spell takes effect immediately after the trigger occurs for the first time, whether or not you want it to, and then Contingency ends.\nThe contingent spell takes effect only on you, even if it can normally target others. You can use only one Contingency spell at a time. If you cast this spell again, the effect of another Contingency spell on you ends. Also, Contingency ends on you if its material component is ever not on your person." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "premonition",
    name: { fr: "Prémonition", en: "Foresight" },
    level: 9,
    school: "divination",
    castingTime: { fr: "1 minute", en: "1 minute" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une plume de colibri", en: "a hummingbird feather" } },
    duration: { fr: "8 heures", en: "8 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature consentante pour lui octroyer la faculté d’entrevoir l’avenir immédiat. Pour toute la durée, la cible a l’Avantage aux Tests d20 et les autres créatures subissent le Désavantage aux jets d’attaque contre elle. Le sort prend fin prématurément si vous le relancez.", en: "You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target has Advantage on D20 Tests, and other creatures have Disadvantage on attack rolls against it. The spell ends early if you cast it again." },
    atHigherLevels: null,
    classes: ["bard","druid","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Prière de guérison", en: "Prayer of Healing" },
    level: 2,
    school: "abjuration",
    castingTime: { fr: "10 minutes", en: "10 minutes" },
    range: { fr: "9 m", en: "30 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Un maximum de cinq créatures que vous choisissez parmi celles qui restent à portée pendant toute l’incantation reçoivent les bénéfices d’un Repos court et récupèrent chacune 2d8 points de vie. Une créature qui profite de ce sort doit terminer un Repos long pour pouvoir en profiter à nouveau.", en: "Up to five creatures of your choice who remain within range for the spell’s entire casting gain the benefits of a Short Rest and also regain 2d8 Hit Points. A creature can’t be affected by this spell again until that creature finishes a Long Rest." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les soins augmentent de 1d8 par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The healing increases by 1d8 for each spell slot level above 2." },
    classes: ["cleric","paladin"],
    source: 'srd-5.2.1',
  },
  {
  ...
  },
  {
    ...
    name: { fr: "Protection contre l’énergie", en: "Protection from Energy" },
    level: 3,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Pour toute la durée, la créature consentante que vous touchez bénéficie de la Résistance à un type de dégâts de votre choix entre : acide, feu, foudre, froid et tonnerre.", en: "For the duration, the willing creature you touch has Resistance to one damage type of your choice: Acid, Cold, Fire, Lightning, or Thunder." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    name: { fr: "Protection contre la mort", en: "Death Ward" },
    level: 4,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
  ...
  },
  {
    ...
    name: { fr: "Protection contre le poison", en: "Protection from Poison" },
    level: 2,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature pour mettre fin sur elle à l’état Empoisonné. Pour toute la durée, la cible a l’Avantage aux jets de sauvegarde pour éviter l’état Empoisonné ou y mettre fin, et bénéficie de la Résistance aux dégâts de poison.", en: "You touch a creature and end the Poisoned condition on it. For the duration, the target has Advantage on saving throws to avoid or end the Poisoned condition, and it has Resistance to Poison damage." },
    atHigherLevels: null,
    classes: ["cleric","druid","paladin","ranger"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Purification de la nourriture et de l’eau", en: "Purify Food and Drink" },
    level: 1,
    school: "transmutation",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "3 m", en: "10 feet" },
    ...
    concentration: false,
    ritual: true,
    description: { fr: "Vous purgez de tout poison et pourriture les aliments et boissons non magiques dans une Sphère de 1,50 m de rayon centrée sur un point à portée.", en: "You remove poison and rot from nonmagical food and drink in a 5-foot-radius Sphere centered on a point within range." },
    atHigherLevels: null,
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous intimez un ordre verbal à une créature que vous voyez à portée, pour la contraindre à accomplir une tâche ou l’empêcher d’exécuter certains actes que vous définissez. La cible doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Charmé pour toute la durée du sort. Elle réussit automatiquement ce JS si elle n’est pas en mesure de comprendre votre ordre. Tant que la créature est ainsi Charmée, elle subit 5d10 dégâts psychiques quand elle se conduit directement à l’encontre de vos instructions. Elle ne peut pas subir ces dégâts plus d’une fois par jour. Vous pouvez donner n’importe quel ordre, en dehors d’une tâche dont l’issue serait forcément fatale à la\ncible. Si l’instruction intimée est suicidaire, le sort prend fin. Les sorts délivrance des malédictions, restauration suprême et souhait mettent chacun fin à ce sort.", en: "You give a verbal command to a creature that you can see within range, ordering it to carry out some service or refrain from an action or a course of activity as you decide. The target must succeed on a Wisdom saving throw or have the Charmed condition for the duration. The target automatically succeeds if it can’t understand your command.\nWhile Charmed, the creature takes 5d10 Psychic damage if it acts in a manner directly counter to your command. It takes this damage no more than once each day.\nYou can issue any command you choose, short of an activity that would result in certain death. Should you issue a suicidal command, the spell ends.\nA Remove Curse, Greater Restoration, or Wish spell ends this spell." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Avec un emplacement du 7e ou 8e niveau, la durée est de 365 jours. Avec un emplacement du 9e niveau, le sort persiste jusqu’à ce qu’un des sorts cités plus haut y mette fin.", en: "Using a Higher-Level Spell Slot. If you use a level 7 or 8 spell slot, the duration is 365 days. If you use a level 9 spell slot, the spell lasts until it is ended by one of the spells mentioned above." },
    classes: ["bard","cleric","druid","paladin","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "rappel-a-la-vie",
    name: { fr: "Rappel à la vie", en: "Raise Dead" },
    level: 5,
    school: "necromancy",
    castingTime: { fr: "1 heure", en: "1 hour" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "un diamant d’une valeur mini- male de 500 po, que le sort détruit", en: "a diamond worth 500+ GP, which the spell consumes" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "D’un contact, vous ramenez à la vie une créature qui n’était pas un Mort-vivant quand elle est morte et dont la mort remonte à un maximum de 10 jours. La créature est ramenée à la vie avec 1 point de vie. Ce sort neutralise également tous les poisons qui affectaient la créature au moment de mourir. Ce sort referme toutes les blessures mortelles, mais ne fait pas repousser l’anatomie manquante. Si la créature a perdu une partie de son anatomie ou des organes essentiels à sa survie ; sa tête par exemple, le sort échoue automatiquement. Revenir d’entre les morts demeure une épreuve. La cible subit un malus de –4 aux Tests d20. Chaque fois qu’elle termine un Repos long, ce malus diminue de 1, jusqu’à ce qu’il tombe à 0.", en: "With a touch, you revive a dead creature if it has been dead no longer than 10 days and it wasn’t Undead when it died.\nThe creature returns to life with 1 Hit Point. This spell also neutralizes any poisons that affected the creature at the time of death.\nThis spell closes all mortal wounds, but it doesn’t restore missing body parts. If the creature is lacking body parts or organs integral for its survival— its head, for instance—the spell automatically fails.\nComing back from the dead is an ordeal. The target takes a −4 penalty to D20 Tests. Every time the target finishes a Long Rest, the penalty is reduced by 1 until it becomes 0." },
    atHigherLevels: null,
    classes: ["bard","cleric","paladin"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Rayon affaiblissant", en: "Ray of Enfeeblement" },
    level: 2,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  {
    id: "rayon-ardent",
    name: { fr: "Rayon ardent", en: "Scorching Ray" },
    level: 2,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous projetez trois rayons de flammes. Vous pouvez cibler une seule cible à portée ou bien plusieurs. Effectuez une attaque de sort à distance pour chaque rayon. Une attaque qui touche sa cible lui inflige 2d6 dégâts de feu.", en: "You hurl three fiery rays. You can hurl them at one target within range or at several. Make a ranged spell attack for each ray. On a hit, the target takes 2d6 Fire damage." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous produisez un rayon supplémentaire par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. You create one additional ray for each spell slot level above 2." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Un rayon de lueur zébrée bleuâtre et glaciale file vers une créature à portée. Effectuez une attaque de sort à distance contre la cible. Si l’attaque touche, la cible subit 1d8 dégâts de froid et sa Vitesse est réduite de 3 m jusqu’au début de votre tour suivant.", en: "A frigid beam of blue-white light streaks toward a creature within range. Make a ranged spell attack against the target. On a hit, it takes 1d8 Cold damage, and its Speed is reduced by 10 feet until the start of your next turn." },
    atHigherLevels: { fr: "Amélioration de sort mineur. Les dégâts augmentent de 1d8 lorsque vous atteignez les niveaux 5 (2d8), 11 (3d8) et 17 (4d8).", en: "Cantrip Upgrade. The damage increases by 1d8 when you reach levels 5 (2d8), 11 (3d8), and 17 (4d8)." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "rayon-de-lune",
    name: { fr: "Rayon de lune", en: "Moonbeam" },
    level: 2,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
    components: { v: true, s: true, m: true, material: { fr: "une feuille de cocculus", en: "a moonseed leaf" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Un large rayon de lueur argentée ténue plonge sous forme d’un Cylindre de 1,50 m de rayon et 12 m de haut, centré sur un point à portée. Jusqu’à la fin du sort, le Cylindre est empli de Lumière faible et vous pouvez entreprendre l’action Magie à vos tours suivants pour déplacer le Cylindre d’un maximum de 18 m. Lorsque le Cylindre apparaît, chaque créature prise à l’intérieur effectue un jet de sauvegarde de Constitution. En cas d’échec, elle subit 2d10 dégâts radiants et, si elle est métamorphosée (par le sort métamorphose, par exemple), elle reprend sa forme véritable et ne peut plus en changer tant qu’elle reste dans le Cylindre. En cas de réussite, elle subit uniquement la moitié de ces dégâts. Toute créature qui voit la zone du sort se déplacer dans son espace, ou qui pénètre dans la zone ou y termine son tour, est également soumise à ce JS. Une même créature n’effectue en aucun cas ce JS plus d’une fois par tour.", en: "A silvery beam of pale light shines down in a 5-foot-radius, 40-foot-high Cylinder centered on a point within range. Until the spell ends, Dim Light fills the Cylinder, and you can take a Magic action on later turns to move the Cylinder up to 60 feet.\nWhen the Cylinder appears, each creature in it makes a Constitution saving throw. On a failed save, a creature takes 2d10 Radiant damage, and if the creature is shape-shifted (as a result of the Polymorph spell, for example), it reverts to its true form and can’t shape-shift until it leaves the Cylinder. On a successful save, a creature takes half as much damage only. A creature also makes this save when the spell’s area moves into its space and when it enters the spell’s area or ends its turn there. A creature makes this save only once per turn." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d10 par niveau d’emplacement au-delà du 2e .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d10 for each spell slot level above 2." },
    classes: ["druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "rayon-de-soleil",
    name: { fr: "Rayon de soleil", en: "Sunbeam" },
    level: 6,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une loupe", en: "a magnifying glass" } },
    duration: { fr: "Concentration, jusqu’à 1 minute", en: "Concentration, up to 1 minute" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous projetez un rayon de soleil sous forme d’une Ligne de 18 m de long et 1,50 m de large. Chaque créature prise dans la Ligne effectue un jet de sauvegarde de Constitution. En cas d’échec, elle subit 6d8 dégâts radiants, ainsi que l’état Aveuglé jusqu’au début de votre tour suivant. En cas de réussite, elle subit uniquement la moitié de ces dégâts. Jusqu’à la fin du sort, vous pouvez entreprendre l’action Magie pour produire une nouvelle Ligne de radiance. Pour toute la durée, un point de radiance brille juste au-dessus de vous. Il émet une Lumière vive sur un rayon de 9 m et une Lumière faible sur 9 m de plus. Cette lumière est celle du soleil.", en: "You launch a sunbeam in a 5-foot-wide, 60-foot-long Line. Each creature in the Line makes a Constitution saving throw. On a failed save, a creature takes 6d8 Radiant damage and has the Blinded condition until the start of your next turn. On a successful save, it takes half as much damage only.\nUntil the spell ends, you can take a Magic action to create a new Line of radiance.\nFor the duration, a mote of brilliant radiance shines above you. It sheds Bright Light in a 30-foot radius and Dim Light for an additional 30 feet. This light is sunlight." },
    atHigherLevels: null,
    classes: ["cleric","druid","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "rayon-empoisonne",
    name: { fr: "Rayon empoisonné", en: "Ray of Sickness" },
    level: 1,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous dardez un rayon verdâtre vers une créature à portée. Effectuez une attaque de sort à distance contre la cible. Si l’attaque touche, la cible subit 2d8 dégâts de poison, ainsi que l’état Empoisonné jusqu’à la fin de votre tour suivant.", en: "You shoot a greenish ray at a creature within range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 Poison damage and has the Poisoned condition until the end of your next turn." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d8 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d8 for each spell slot level above 1." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "rayon-tracant",
    name: { fr: "Rayon traçant", en: "Guiding Bolt" },
    level: 1,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "36 m", en: "120 feet" },
  ...
  {
    id: "regeneration",
    name: { fr: "Régénération", en: "Regenerate" },
    level: 7,
    school: "transmutation",
    castingTime: { fr: "1 minute", en: "1 minute" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "un moulin à prières", en: "a prayer wheel" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Une créature que vous touchez physiquement récupère 4d8 + 15 points de vie. Pour toute la durée, la cible récupère 1 point de vie au début de chacun de ses tours et les parties sectionnées de son anatomie repoussent en 2 minutes.", en: "A creature you touch regains 4d8 + 15 Hit Points. For the duration, the target regains 1 Hit Point at the start of each of its turns, and any severed body parts regrow after 2 minutes." },
    atHigherLevels: null,
    classes: ["bard","cleric","druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "reincarnation",
    name: { fr: "Réincarnation", en: "Reincarnate" },
    level: 5,
    school: "necromancy",
    castingTime: { fr: "1 heure", en: "1 hour" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "des huiles rares d’une valeur minimale de 1 000 po, que le sort détruit", en: "rare oils worth 1,000+ GP, which the spell consumes" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement un Humanoïde mort ou l’un de ses restes. Si la créature n’est pas morte depuis plus de 10 jours, le sort forme un nouveau corps et appelle son âme pour prendre possession de ce corps. Lancez 1d10 en consultant la table suivante pour déterminer l’espèce du nouveau corps ou laissez le MJ choisir directement une espèce jouable.\n1d10 — Espèce\n1 — Relancez le dé\n2 — Drakéide\n3 — Elfe\n4 — Gnome\n5 — Goliath\n6 — Halfelin\n7 — Humain\n8 — Nain\n9 — Orc\n10 — Tieffelin\nLa créature réincarnée, qui fait les choix proposés par la description de l’espèce, se souvient de son ancienne vie et de ses expériences. Elle conserve les capacités dont elle disposait sous sa forme d’origine, si ce n’est qu’elle perd les traits de l’ancienne forme et acquiert ceux de la nouvelle.", en: "You touch a dead Humanoid or a piece of one. If the creature has been dead no longer than 10 days, the spell forms a new body for it and calls the soul to enter that body. Roll 1d10 and consult the table below to determine the body’s species, or the GM chooses another playable species.\n1d10 — Species\n1 — Roll again.\n2 — Dragonborn\n3 — Dwarf\n4 — Elf\n5 — Gnome\n6 — Goliath\n7 — Halfling\n8 — Human\n9 — Orc\n10 — Tiefling\nThe reincarnated creature makes any choices that a species’ description offers, and the creature recalls its former life. It retains the capabilities it had in its original form, except it loses the traits of its previous species and gains the traits of its new one." },
    atHigherLevels: null,
    classes: ["druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "reparation",
    name: { fr: "Réparation", en: "Mending" },
    level: 0,
    school: "transmutation",
    castingTime: { fr: "1 minute", en: "1 minute" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "deux magnétites", en: "two lodestones" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Ce sort répare une dégradation (déchirure ou bris) sur l’objet que vous touchez, comme un maillon de chaîne brisé, une clef en deux morceaux, une cape déchirée ou une outre percée. Tant que la dégradation ne dépasse pas 30 cm dans quelque dimension que ce soit, vous la réparez et il n’en reste nulle trace. Ce sort peut réparer la structure physique d’un objet magique, mais il ne lui rendra pas sa magie.", en: "This spell repairs a single break or tear in an object you touch, such as a broken chain link, two halves of a broken key, a torn cloak, or a leaking wineskin. As long as the break or tear is no larger than 1 foot in any dimension, you mend it, leaving no trace of the former damage.\nThis spell can physically repair a magic item, but it can’t restore magic to such an object." },
    atHigherLevels: null,
  ...
  {
    id: "repli-expeditif",
    name: { fr: "Repli expéditif", en: "Expeditious Retreat" },
    level: 1,
    school: "transmutation",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "personnelle", en: "Self" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous entreprenez l’action Pointe et, jusqu’à la fin du sort, vous pouvez entreprendre cette même action par une action Bonus.", en: "You take the Dash action, and until the spell ends, you can take that action again as a Bonus Action." },
    atHigherLevels: null,
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "represailles-infernales",
    name: { fr: "Représailles infernales", en: "Hellish Rebuke" },
    level: 1,
    school: "evocation",
    castingTime: { fr: "Réaction, que vous jouez lors- qu’une créature que vous voyez dans un rayon de 18 m vous inflige des dégâts.", en: "Reaction, which you take in response to taking damage from a creature that you can see within 60 feet of yourself" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: true, m: false },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "La créature qui vous a infligé des dégâts se retrouve un court instant cernée de flammes vertes. Elle effectue un jet de sauvegarde de Dextérité, et subit 2d10 dégâts de feu en cas d’échec, la moitié en cas de réussite.", en: "The creature that damaged you is momentarily surrounded by green flames. It makes a Dexterity saving throw, taking 2d10 Fire damage on a failed save or half as much damage on a successful one." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les dégâts augmentent de 1d10 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The damage increases by 1d10 for each spell slot level above 1." },
    classes: ["warlock"],
    source: 'srd-5.2.1',
  },
  {
    id: "resistance",
    name: { fr: "Résistance", en: "Resistance" },
    level: 0,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: true,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature consentante en choisissant un type de dégâts entre : acide, contondants, feu, foudre, froid, nécrotiques, perforants, poison, radiants, tonnerre et tranchants. Quand la créature subit des dégâts du type retenu avant la fin du sort, elle réduit les dégâts subis de 1d4. Une même créature ne peut bénéficier qu’une fois par tour de ce sort.", en: "You touch a willing creature and choose a damage type: Acid, Bludgeoning, Cold, Fire, Lightning, Necrotic, Piercing, Poison, Radiant, Slashing, or Thunder. When the creature takes damage of the chosen type before the spell ends, the creature reduces the total damage taken by 1d4. A creature can benefit from this spell only once per turn." },
    atHigherLevels: null,
    classes: ["cleric","druid"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Respiration aquatique", en: "Water Breathing" },
    level: 3,
    school: "transmutation",
    castingTime: { fr: "action ou rituel", en: "Action or Ritual" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un court roseau", en: "a short reed" } },
    duration: { fr: "24 heures", en: "24 hours" },
    concentration: false,
    ritual: true,
    description: { fr: "Ce sort octroie la faculté de respirer sous l’eau à un maximum de dix créatures consentantes que vous choisissez à portée, jusqu’à la fin du sort. Les créatures affectées conservent leurs autres modes respiratoires.", en: "This spell grants up to ten willing creatures of your choice within range the ability to breathe underwater until the spell ends. Affected creatures also retain their normal mode of respiration." },
    atHigherLevels: null,
    classes: ["druid","ranger","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Restauration partielle", en: "Lesser Restoration" },
    level: 2,
    school: "abjuration",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature pour mettre fin à un état qui l’affecte parmi : Assourdi, Aveuglé, Empoisonné et Paralysé.", en: "You touch a creature and end one condition on it: Blinded, Deafened, Paralyzed, or Poisoned." },
    atHigherLevels: null,
    classes: ["bard","cleric","druid","paladin","ranger"],
    source: 'srd-5.2.1',
  },
  {
    ...
    name: { fr: "Restauration suprême", en: "Greater Restoration" },
    level: 5,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez physiquement une créature pour lui retirer magiquement l’un des effets suivants : • 1 niveau d’Épuisement • L’état Charmé ou Pétrifié • Une malédiction, y compris l’Harmonisation éventuelle de la cible avec un objet magique maudit • Toute réduction de l’une des valeurs de caractéristique de la cible • Toute réduction du maximum de points de vie de la cible", en: "You touch a creature and magically remove one of the following effects from it: • 1 Exhaustion level • The Charmed or Petrified condition • A curse, including the target’s Attunement to a cursed magic item • Any reduction to one of the target’s ability scores • Any reduction to the target’s Hit Point maximum" },
    atHigherLevels: null,
    classes: ["bard","cleric","druid","paladin","ranger"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "retour-a-la-vie",
    name: { fr: "Retour à la vie", en: "Revivify" },
    level: 3,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "un diamant d’une valeur mini- male de 300 po, que le sort détruit", en: "a diamond worth 300+ GP, which the spell consumes" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous touchez une créature morte dans la minute qui vient de s’écouler. La créature est ramenée à la vie avec 1 point de vie. Ce sort ne peut pas affecter une créature morte de vieillesse, pas plus qu’il ne restitue l’anatomie manquante.", en: "You touch a creature that has died within the last minute. That creature revives with 1 Hit Point. This spell can’t revive a creature that has died of old age, nor does it restore any missing body parts." },
    atHigherLevels: null,
    classes: ["cleric","druid","paladin","ranger"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "sanctuaire",
    name: { fr: "Sanctuaire", en: "Sanctuary" },
    level: 1,
    school: "abjuration",
    castingTime: { fr: "action Bonus", en: "Bonus Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: true, m: true, material: { fr: "un éclat de verre issu d’un miroir", en: "a shard of glass from a mirror" } },
    duration: { fr: "1 minute", en: "1 minute" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous protégez une créature à portée. Jusqu’à la fin du sort, toute créature qui cible la créature protégée avec un jet d’attaque ou un sort nuisible doit réussir un jet de sauvegarde de Sagesse, sans quoi elle doit choisir une autre cible pour ne pas perdre l’attaque ou le sort. Ce sort ne protège pas la créature contre les zones d’effet. Le sort prend fin pour la créature protégée si elle effectue un jet d’attaque, lance un sort ou inflige des dégâts.", en: "You ward a creature within range. Until the spell ends, any creature who targets the warded creature with an attack roll or a damaging spell must succeed on a Wisdom saving throw or either choose a new target or lose the attack or spell. This spell doesn’t protect the warded creature from areas of effect. The spell ends if the warded creature makes an attack roll, casts a spell, or deals damage." },
    atHigherLevels: null,
    classes: ["cleric"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "simulacre",
    name: { fr: "Simulacre", en: "Simulacrum" },
    level: 7,
    school: "illusion",
    castingTime: { fr: "12 heures", en: "12 hours" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "poudre de rubis d’une valeur minimale de 1 500 po, que le sort détruit", en: "powdered ruby worth 1,500+ GP, which the spell consumes" } },
    duration: { fr: "jusqu’à dissipation", en: "Until dispelled" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous façonnez un simulacre d’une Bête ou d’un Humanoïde qui se trouve dans un rayon de 3 m pendant tout le temps d’incantation du sort. Vous terminez l’incantation en touchant physiquement la créature en même temps qu’un tas de neige ou de glace de même taille que la créature, le tas prenant alors la forme du simulacre ; une nouvelle créature. Il reprend le profil de la créature d’origine au moment de l’incantation, si ce n’est qu’il s’agit d’un Artificiel, que son maximum de points de vie est moitié moindre et qu’il ne peut pas lancer de sorts. Le simulacre est Amical envers vous et les créatures que vous désignez. Il obéit à vos ordres et agit à votre tour au combat. Le simulacre ne peut pas gagner de niveaux ni prendre de Repos, courts ou longs. Si le simulacre subit des dégâts, le seul moyen de lui restituer des points de vie consiste à le réparer lors d’un Repos long de votre part, durant lequel vous devez dépenser des composantes : l’équivalent de 100 po par point de vie restitué. Le simulacre doit rester dans un rayon de 1,50 m de vous durant toute l’opération. Le simulacre persiste jusqu’à ce qu’il tombe à 0 point de vie, après quoi il retrouve sa substance aqueuse et fond. Si vous relancez ce sort, tout autre simulacre actif que vous avez créé par ce même sort est aussitôt détruit.", en: "You create a simulacrum of one Beast or Humanoid that is within 10 feet of you for the entire casting of the spell. You finish the casting by touching both the creature and a pile of ice or snow that is the same size as that creature, and the pile turns into the simulacrum, which is a creature. It uses the game statistics of the original creature at the time of casting, except it is a Construct, its Hit Point maximum is half as much, and it can’t cast this spell.\nThe simulacrum is Friendly to you and creatures you designate. It obeys your commands and acts on your turn in combat. The simulacrum can’t gain levels, and it can’t take Short or Long Rests.\nIf the simulacrum takes damage, the only way to restore its Hit Points is to repair it as you take a Long Rest, during which you expend components worth 100 GP per Hit Point restored. The simulacrum must stay within 5 feet of you for the repair.\nThe simulacrum lasts until it drops to 0 Hit Points, at which point it reverts to snow and melts away. If you cast this spell again, any simulacrum you created with this spell is instantly destroyed." },
    atHigherLevels: null,
    classes: ["wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "simulacre-de-vie",
    name: { fr: "Simulacre de vie", en: "False Life" },
    level: 1,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
    components: { v: true, s: true, m: true, material: { fr: "une goutte d’alcool", en: "a drop of alcohol" } },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Vous recevez 2d4 + 4 points de vie temporaires.", en: "You gain 2d4 + 4 Temporary Hit Points." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous recevez 5 points de vie temporaires supplémentaires par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. You gain 5 additional Temporary Hit Points for each spell slot level above 1." },
    classes: ["sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "soins",
    name: { fr: "Soins", en: "Cure Wounds" },
    level: 1,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "La créature que vous touchez physiquement récupère un nombre de points de vie égal à 2d8 + votre modificateur de caractéristique d’incantation.", en: "A creature you touch regains a number of Hit Points equal to 2d8 plus your spellcasting ability modifier." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les soins augmentent de 2d8 par niveau d’emplacement au-delà du 1er .", en: "Using a Higher-Level Spell Slot. The healing increases by 2d8 for each spell slot level above 1." },
    classes: ["bard","cleric","druid","paladin","ranger"],
    source: 'srd-5.2.1',
  },
  {
    id: "soins-de-groupe",
    name: { fr: "Soins de groupe", en: "Mass Cure Wounds" },
    level: 5,
    school: "abjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une vague d’énergie curative déferle depuis un point que vous voyez à portée. Désignez un maximum de six créatures dans une Sphère de 9 m de rayon centrée sur ce point. Chaque cible récupère autant de points de vie que 5d8 + votre modificateur de caractéristique d’incantation.", en: "A wave of healing energy washes out from a point you can see within range. Choose up to six creatures in a 30-foot-radius Sphere centered on that point. Each target regains Hit Points equal to 5d8 plus your spellcasting ability modifier." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Les soins augmentent de 1d8 par niveau d’emplacement au-delà du 5e .", en: "Using a Higher-Level Spell Slot. The healing increases by 1d8 for each spell slot level above 5." },
    classes: ["bard","cleric","druid"],
    source: 'srd-5.2.1',
  },
  {
  ...
  {
    id: "stabilisation",
    name: { fr: "Stabilisation", en: "Spare the Dying" },
    level: 0,
    school: "necromancy",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "4,50 m", en: "15 feet" },
    components: { v: true, s: true, m: false },
    duration: { fr: "instantanée", en: "Instantaneous" },
    concentration: false,
    ritual: false,
    description: { fr: "Choisissez à portée une créature dotée de 0 point de vie, mais qui n’est pas morte. La créature est Stabilisée.", en: "Choose a creature within range that has 0 Hit Points and isn’t dead. The creature becomes Stable." },
    atHigherLevels: { fr: "Amélioration de sort mineur. La portée augmente lorsque vous atteignez les niveaux 5 (9 m), 11 (18 m) et 17 (36 m).", en: "Cantrip Upgrade. The range doubles when you reach levels 5 (30 feet), 11 (60 feet), and 17 (120 feet)." },
    classes: ["cleric","druid"],
    source: 'srd-5.2.1',
  },
  {
    id: "suggestion",
    name: { fr: "Suggestion", en: "Suggestion" },
    level: 2,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "9 m", en: "30 feet" },
    components: { v: true, s: false, m: true, material: { fr: "une goutte de miel", en: "a drop of honey" } },
    duration: { fr: "Concentration, jusqu’à 8 heures", en: "Concentration, up to 8 hours" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous suggérez une ligne de conduite par 25 mots ou moins afin d’influencer magiquement une créature que vous voyez à portée, qui vous entend et vous comprend. La suggestion doit paraître raisonnable et ne pas présenter de risque évident d’infliger des dégâts à la cible ni à ses alliés. Vous pourriez ainsi formuler : « Récupère la clef de la chambre forte de la secte et apporte-la-moi. » Ou bien : « Cesse de combattre, quitte la bibliothèque sans faire d’histoires et ne reviens pas. » La cible doit réussir un jet de sauvegarde de Sagesse sous peine de subir l’état Charmé pour toute la durée ou jusqu’à que vous ou l’un de vos alliés lui infligiez des dégâts. La cible Charmée se soumet à la suggestion de son mieux. L’activité suggérée peut s’étendre sur toute la durée, mais s’il est possible de l’accomplir plus tôt, le sort prend fin sur la cible dès qu’elle en a terminé.", en: "You suggest a course of activity—described in no more than 25 words—to one creature you can see within range that can hear and understand you. The suggestion must sound achievable and not involve anything that would obviously deal damage to the target or its allies. For example, you could say, “Fetch the key to the cult’s treasure vault, and give the key to me.” Or you could say, “Stop fighting, leave this library peacefully, and don’t return.”\nThe target must succeed on a Wisdom saving throw or have the Charmed condition for the duration or until you or your allies deal damage to the target. The Charmed target pursues the suggestion to the best of its ability. The suggested activity can continue for the entire duration, but if the suggested activity can be completed in a shorter time, the spell ends for the target upon completing it." },
    atHigherLevels: null,
    classes: ["bard","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "telekinesie",
    name: { fr: "Télékinésie", en: "Telekinesis" },
    level: 5,
    school: "transmutation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
  ...
  {
    id: "teleportation",
    name: { fr: "Téléportation", en: "Teleport" },
    level: 7,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "3 m", en: "10 feet" },
  ...
  {
    id: "tempete-de-feu",
    name: { fr: "Tempête de feu", en: "Fire Storm" },
    level: 7,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "45 m", en: "150 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Une tempête de flammes éclate à portée. La zone de la tempête consiste en un maximum de 10 Cubes de 3 m, que vous disposez à votre guise. Chaque Cube doit être contigu à au moins un autre Cube. Chaque créature prise dans la zone effectue un jet de sauvegarde de Dextérité et subit 7d10 dégâts de feu en cas d’échec, la moitié en cas de réussite. L’explosion embrase les objets inflammables de la zone qui ne sont portés par personne.", en: "A storm of fire appears within range. The area of the storm consists of up to ten 10-foot Cubes, which you arrange as you like. Each Cube must be contiguous with at least one other Cube. Each creature in the area makes a Dexterity saving throw, taking 7d10 Fire damage on a failed save or half as much damage on a successful one.\nFlammable objects in the area that aren’t being worn or carried start burning." },
    atHigherLevels: null,
    classes: ["cleric","druid","sorcerer"],
    source: 'srd-5.2.1',
  },
  ...
  },
  {
    ...
    name: { fr: "Tempête vengeresse", en: "Storm of Vengeance" },
    level: 9,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "1,5 km", en: "1 mile" },
  ...
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
    components: { v: true, s: false, m: true, material: { fr: "une touffe de fourrure de chauve-souris et un bout de charbon", en: "bat fur and a piece of coal" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: false,
    description: { fr: "Pour toute la durée, des Ténèbres magiques se déploient depuis un point à portée en remplissant une Sphère de 4,50 m de rayon. La Vision dans le noir ne perce pas ces ténèbres et les lumières non magiques n’illuminent pas dans la Sphère. Au lieu de cela, vous pouvez lancer le sort sur un objet porté par personne, de manière à ce que les Ténèbres emplissent une Émanation de 4,50 m centrée sur l’objet. Il suffit de recouvrir cet objet d’une surface opaque, comme une gamelle ou un heaume, pour bloquer les Ténèbres. Si tout ou partie de ce sort chevauche la zone de Lumière vive ou faible créée par un sort du 2e niveau ou inférieur, l’effet qui produit cette lumière est dissipé.", en: "For the duration, magical Darkness spreads from a point within range and fills a 15-foot-radius Sphere. Darkvision can’t see through it, and nonmagical light can’t illuminate it.\nAlternatively, you cast the spell on an object that isn’t being worn or carried, causing the Darkness to fill a 15-foot Emanation originating from that object. Covering that object with something opaque, such as a bowl or helm, blocks the Darkness.\nIf any of this spell’s area overlaps with an area of Bright Light or Dim Light created by a spell of level 2 or lower, that other spell is dispelled." },
    atHigherLevels: null,
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "texte-illusoire",
    name: { fr: "Texte illusoire", en: "Illusory Script" },
    level: 1,
    school: "illusion",
    castingTime: { fr: "1 minute ou rituel", en: "1 minute or Ritual" },
    range: { fr: "contact", en: "Touch" },
    components: { v: false, s: true, m: true, material: { fr: "de l’encre d’une valeur minimale de 10 po, que le sort détruit", en: "ink worth 10+ GP, which the spell consumes" } },
    duration: { fr: "10 jours", en: "10 days" },
    concentration: false,
    ritual: true,
    description: { fr: "Vous écrivez sur du parchemin, du papier ou autre surface adaptée et y insufflez une illusion qui persiste pour toute la durée. À vos yeux, ainsi qu’à ceux de toute créature que vous désignez à l’incantation du sort, le texte paraît normalement écrit, de votre main, et porte le message voulu de votre part. Pour toute autre créature, le texte paraît rédigé selon un alphabet inconnu ou magique, parfaitement incompréhensible. Une autre option consiste à donner un sens différent au message, qui semble écrit par quelqu’un d’autre et dans une autre langue que vous maîtrisez. Si le sort est dissipé, le texte original et l’illusion disparaissent. Une créature dotée de la Vision lucide peut lire le message caché.", en: "You write on parchment, paper, or another suitable material and imbue it with an illusion that lasts for the duration. To you and any creatures you designate when you cast the spell, the writing appears normal, seems to be written in your hand, and conveys whatever meaning you intended when you wrote the text. To all others, the writing appears as if it were written in an unknown or magical script that is unintelligible. Alternatively, the illusion can alter the meaning, handwriting, and language of the text, though the language must be one you know.\nIf the spell is dispelled, the original script and the illusion both disappear.\nA creature that has Truesight can read the hidden message." },
    atHigherLevels: null,
    classes: ["bard","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  ...
  {
    id: "vague-tonnante",
    name: { fr: "Vague tonnante", en: "Thunderwave" },
    level: 1,
    school: "evocation",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "personnelle", en: "Self" },
  ...
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une carotte séchée", en: "a dried carrot" } },
    duration: { fr: "8 heures", en: "8 hours" },
    concentration: false,
    ritual: false,
    description: { fr: "Pour toute la durée, une créature consentante que vous touchez physiquement acquiert la Vision dans le noir sur 45 m.", en: "For the duration, a willing creature you touch has Darkvision with a range of 150 feet." },
    atHigherLevels: null,
    classes: ["druid","ranger","sorcerer","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "vision-supreme",
    name: { fr: "Vision suprême", en: "True Seeing" },
    level: 6,
    school: "divination",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "poudre de champignon d’une valeur minimale de 25 po, que le sort détruit", en: "mushroom powder worth 25+ GP, which the spell consumes" } },
    duration: { fr: "1 heure", en: "1 hour" },
    concentration: false,
    ritual: false,
    description: { fr: "Pour toute la durée, une créature consentante que vous touchez physiquement acquiert la Vision lucide sur 36 m.", en: "For the duration, the willing creature you touch has Truesight with a range of 120 feet." },
    atHigherLevels: null,
    classes: ["bard","cleric","sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "voie-vegetale",
    name: { fr: "Voie végétale", en: "Transport via Plants" },
    level: 6,
    school: "conjuration",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "3 m", en: "10 feet" },
    ...
    concentration: false,
    ritual: false,
    description: { fr: "Ce sort crée un lien magique entre une plante inanimée à portée, de taille G ou supérieure, et une autre plante du même plan d’existence, sans contrainte de distance. Vous devez avoir déjà vu ou touché la plante de destination au moins une fois. Pour toute la durée, toutes les créatures peuvent s’avancer dans la plante ciblée et ressortir par la plante de destination en y consacrant 1,50 m de leur déplacement.", en: "This spell creates a magical link between a Large or larger inanimate plant within range and another plant, at any distance, on the same plane of existence. You must have seen or touched the destination plant at least once before. For the duration, any creature can step into the target plant and exit from the destination plant by using 5 feet of movement." },
    atHigherLevels: null,
    classes: ["druid"],
    source: 'srd-5.2.1',
  },
  {
    ...
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "contact", en: "Touch" },
    components: { v: true, s: true, m: true, material: { fr: "une plume", en: "a feather" } },
    duration: { fr: "Concentration, jusqu’à 10 minutes", en: "Concentration, up to 10 minutes" },
    concentration: true,
    ritual: false,
    description: { fr: "Vous touchez une créature consentante. Pour toute la durée, la cible acquiert une Vitesse de vol de 18 m et bénéficie du vol stationnaire. Lorsque le sort prend fin, la cible tombe si elle est toujours dans les airs, à moins de pouvoir arrêter sa chute.", en: "You touch a willing creature. For the duration, the target gains a Fly Speed of 60 feet and can hover. When the spell ends, the target falls if it is still aloft unless it can stop the fall." },
    atHigherLevels: { fr: "Emplacement de niveau supérieur. Vous pouvez cibler une créature supplémentaire par niveau d’emplacement au-delà du 3e .", en: "Using a Higher-Level Spell Slot. You can target one additional creature for each spell slot level above 3." },
    classes: ["sorcerer","warlock","wizard"],
    source: 'srd-5.2.1',
  },
  {
    id: "zone-de-verite",
    name: { fr: "Zone de vérité", en: "Zone of Truth" },
    level: 2,
    school: "enchantment",
    castingTime: { fr: "action", en: "Action" },
    range: { fr: "18 m", en: "60 feet" },
