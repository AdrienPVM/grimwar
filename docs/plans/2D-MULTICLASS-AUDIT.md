...
> **Périmètre V1** : SRD 2024 multiclassing — prérequis par classe, ajout d'une nouvelle classe via level-up, sous-ensemble de proficiencies, table de spell slots unifiée. Cf. décision LOCKED `CLAUDE.md > Multi-classing` et SPEC `docs/plans/MVP-V1-SPEC.md > Levelling V1`.
...
|---|---|---|---|---|
| **2D.1** | ✅ commit `b3093fb` | Cet audit (doc-only) | `docs/plans/2D-MULTICLASS-AUDIT.md` | direct main (non protégé) |
