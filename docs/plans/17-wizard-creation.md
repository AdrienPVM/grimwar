...
Cause-racine + diagnostic en **[docs/plans/DEBT.md > D3](./DEBT.md)**.

Dette `featAtLevel1` (don au niveau 1, variant lié à campagne) transférée au plan 14 — voir **[docs/plans/DEBT.md > D4](./DEBT.md)**.

## Pourquoi cette page existe encore

Pour ne pas casser les renvois historiques dans les autres plans, le `git log`, et `docs/plans/00-overview.md`. Le numéro 17 reste réservé (ne pas réutiliser sur un autre plan, pour préserver la trace).
