...
import type { Campaign, CampaignVariants } from '@/shared/types/campaign';
 ...
 * description, le mode de dés par défaut de la table et les 4 variantes 5e
 * (`featAtLevel1`, `flanking`, `slowHealing`, `grittyRealism`). Persiste via
 * `updateCampaign`, qui deep-merge le patch `settings` côté service.
 *
 ...
 *
 * Ni `language` (switch runtime EN déféré S5) ni `status` ne sont exposés ici :
 * on ne montre que les réglages qui ont un consommateur user-visible en V1.
 */
